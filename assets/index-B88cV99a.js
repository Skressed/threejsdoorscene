...
}`;function Cx(n,e,t){let i=new Sl;const r=new Ze,s=new Ze,o=new st,a=new Ym({depthPacking:om}),l=new $m,c={},u=t.maxTextureSize,f={[Qn]:Bt,[Bt]:Qn,[jt]:jt},d=new ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ze},radius:{value:4}},vertexShader:wx,fragmentShader:Rx}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const v=new ni;v.setAttribute("position",new _n(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Lt(v,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=_f;let h=this.type;this.render=function(C,L,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const T=n.getRenderTarget(),y=n.getActiveCubeFace(),D=n.getActiveMipmapLevel(),k=n.state;k.setBlending(jn),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const q=h!==Cn&&this.type===Cn,Z=h===Cn&&this.type!==Cn;for(let te=0,K=C.length;te<K;te++){const ne=C[te],z=ne.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",ne,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const he=z.getFrameExtents();if(r.multiply(he),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/he.x),r.x=s.x*he.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/he.y),r.y=s.y*he.y,z.mapSize.y=s.y)),z.map===null||q===!0||Z===!0){const ye=this.type!==Cn?{minFilter:an,magFilter:an}:{};z.map!==null&&z.map.dispose(),z.map=new Ti(r.x,r.y,ye),z.map.texture.name=ne.name+".shadowMap",z.camera.updateProjectionMatrix()}n.setRenderTarget(z.map),n.clear();const pe=z.getViewportCount();for(let ye=0;ye<pe;ye++){const Ue=z.getViewport(ye);o.set(s.x*Ue.x,s.y*Ue.y,s.x*Ue.z,s.y*Ue.w),k.viewport(o),z.updateMatrices(ne,ye),i=z.getFrustum(),E(L,F,z.camera,ne,this.type)}z.isPointLightShadow!==!0&&this.type===Cn&&w(z,F),z.needsUpdate=!1}h=this.type,m.needsUpdate=!1,n.setRenderTarget(T,y,D)};function w(C,L){const F=e.update(S);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Ti(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,n.setRenderTarget(C.mapPass),n.clear(),n.renderBufferDirect(L,null,F,d,S,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,n.setRenderTarget(C.map),n.clear(),n.renderBufferDirect(L,null,F,p,S,null)}function b(C,L,F,T){let y=null;const D=F.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(D!==void 0)y=D;else if(y=F.isPointLight===!0?l:a,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){const k=y.uuid,q=L.uuid;let Z=c[k];Z===void 0&&(Z={},c[k]=Z);let te=Z[q];te===void 0&&(te=y.clone(),Z[q]=te,L.addEventListener("dispose",R)),y=te}if(y.visible=L.visible,y.wireframe=L.wireframe,T===Cn?y.side=L.shadowSide!==null?L.shadowSide:L.side:y.side=L.shadowSide!==null?L.shadowSide:f[L.side],y.alphaMap=L.alphaMap,y.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,y.map=L.map,y.clipShadows=L.clipShadows,y.clippingPlanes=L.clippingPlanes,y.clipIntersection=L.clipIntersection,y.displacementMap=L.displacementMap,y.displacementScale=L.displacementScale,y.displacementBias=L.displacementBias,y.wireframeLinewidth=L.wireframeLinewidth,y.linewidth=L.linewidth,F.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const k=n.properties.get(y);k.light=F}return y}function E(C,L,F,T,y){if(C.visible===!1)return;if(C.layers.test(L.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&y===Cn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,C.matrixWorld);const q=e.update(C),Z=C.material;if(Array.isArray(Z)){const te=q.groups;for(let K=0,ne=te.length;K<ne;K++){const z=te[K],he=Z[z.materialIndex];if(he&&he.visible){const pe=b(C,he,T,y);C.onBeforeShadow(n,C,L,F,q,pe,z),n.renderBufferDirect(F,null,q,pe,C,z),C.onAfterShadow(n,C,L,F,q,pe,z)}}}else if(Z.visible){const te=b(C,Z,T,y);C.onBeforeShadow(n,C,L,F,q,te,null),n.renderBufferDirect(F,null,q,te,C,null),C.onAfterShadow(n,C,L,F,q,te,null)}}const k=C.children;for(let q=0,Z=k.length;q<Z;q++)E(k[q],L,F,T,y)}function R(C){C.target.removeEventListener("dispose",R);for(const F in c){const T=c[F],y=C.target.uuid;y in T&&(T[y].dispose(),delete T[y])}}}const Px={[ra]:sa,[oa]:ca,[aa]:ua,[nr]:la,[sa]:ra,[ca]:oa,[ua]:aa,[la]:nr};function Dx(n,e){function t(){let I=!1;const fe=new st;let de=null;const Re=new st(0,0,0,0);return{setMask:function(ce){de!==ce&&!I&&(n.colorMask(ce,ce,ce,ce),de=ce)},setLocked:function(ce){I=ce},setClear:function(ce,re,De,ze,lt){lt===!0&&(ce*=ze,re*=ze,De*=ze),fe.set(ce,re,De,ze),Re.equals(fe)===!1&&(n.clearColor(ce,re,De,ze),Re.copy(fe))},reset:function(){I=!1,de=null,Re.set(-1,0,0,0)}}}function i(){let I=!1,fe=!1,de=null,Re=null,ce=null;return{setReversed:function(re){if(fe!==re){const De=e.get("EXT_clip_control");re?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT),fe=re;const ze=ce;ce=null,this.setClear(ze)}},getReversed:function(){return fe},setTest:function(re){re?se(n.DEPTH_TEST):_e(n.DEPTH_TEST)},setMask:function(re){de!==re&&!I&&(n.depthMask(re),de=re)},setFunc:function(re){if(fe&&(re=Px[re]),Re!==re){switch(re){case ra:n.depthFunc(n.NEVER);break;case sa:n.depthFunc(n.ALWAYS);break;case oa:n.depthFunc(n.LESS);break;case nr:n.depthFunc(n.LEQUAL);break;case aa:n.depthFunc(n.EQUAL);break;case la:n.depthFunc(n.GEQUAL);break;case ca:n.depthFunc(n.GREATER);break;case ua:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Re=re}},setLocked:function(re){I=re},setClear:function(re){ce!==re&&(fe&&(re=1-re),n.clearDepth(re),ce=re)},reset:function(){I=!1,de=null,Re=null,ce=null,fe=!1}}}function r(){let I=!1,fe=null,de=null,Re=null,ce=null,re=null,De=null,ze=null,lt=null;return{setTest:function(et){I||(et?se(n.STENCIL_TEST):_e(n.STENCIL_TEST))},setMask:function(et){fe!==et&&!I&&(n.stencilMask(et),fe=et)},setFunc:function(et,En,ln){(de!==et||Re!==En||ce!==ln)&&(n.stencilFunc(et,En,ln),de=et,Re=En,ce=ln)},setOp:function(et,En,ln){(re!==et||De!==En||ze!==ln)&&(n.stencilOp(et,En,ln),re=et,De=En,ze=ln)},setLocked:function(et){I=et},setClear:function(et){lt!==et&&(n.clearStencil(et),lt=et)},reset:function(){I=!1,fe=null,de=null,Re=null,ce=null,re=null,De=null,ze=null,lt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},f={},d=new WeakMap,p=[],v=null,S=!1,m=null,h=null,w=null,b=null,E=null,R=null,C=null,L=new je(0,0,0),F=0,T=!1,y=null,D=null,k=null,q=null,Z=null;const te=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,ne=0;const z=n.getParameter(n.VERSION);z.indexOf("WebGL")!==-1?(ne=parseFloat(/^WebGL (\d)/.exec(z)[1]),K=ne>=1):z.indexOf("OpenGL ES")!==-1&&(ne=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),K=ne>=2);let he=null,pe={};const ye=n.getParameter(n.SCISSOR_BOX),Ue=n.getParameter(n.VIEWPORT),Je=new st().fromArray(ye),Qe=new st().fromArray(Ue);function Ye(I,fe,de,Re){const ce=new Uint8Array(4),re=n.createTexture();n.bindTexture(I,re),n.texParameteri(I,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(I,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let De=0;De<de;De++)I===n.TEXTURE_3D||I===n.TEXTURE_2D_ARRAY?n.texImage3D(fe,0,n.RGBA,1,1,Re,0,n.RGBA,n.UNSIGNED_BYTE,ce):n.texImage2D(fe+De,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ce);return re}const ee={};ee[n.TEXTURE_2D]=Ye(n.TEXTURE_2D,n.TEXTURE_2D,1),ee[n.TEXTURE_CUBE_MAP]=Ye(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ee[n.TEXTURE_2D_ARRAY]=Ye(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ee[n.TEXTURE_3D]=Ye(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(n.DEPTH_TEST),o.setFunc(nr),W(!1),O(uc),se(n.CULL_FACE),H(jn);function se(I){u[I]!==!0&&(n.enable(I),u[I]=!0)}function _e(I){u[I]!==!1&&(n.disable(I),u[I]=!1)}function Le(I,fe){return f[I]!==fe?(n.bindFramebuffer(I,fe),f[I]=fe,I===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=fe),I===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=fe),!0):!1}function we(I,fe){let de=p,Re=!1;if(I){de=d.get(fe),de===void 0&&(de=[],d.set(fe,de));const ce=I.textures;if(de.length!==ce.length||de[0]!==n.COLOR_ATTACHMENT0){for(let re=0,De=ce.length;re<De;re++)de[re]=n.COLOR_ATTACHMENT0+re;de.length=ce.length,Re=!0}}else de[0]!==n.BACK&&(de[0]=n.BACK,Re=!0);Re&&n.drawBuffers(de)}function We(I){return v!==I?(n.useProgram(I),v=I,!0):!1}const A={[_i]:n.FUNC_ADD,[Lp]:n.FUNC_SUBTRACT,[Ip]:n.FUNC_REVERSE_SUBTRACT};A[Up]=n.MIN,A[Np]=n.MAX;const g={[Fp]:n.ZERO,[Op]:n.ONE,[Bp]:n.SRC_COLOR,[na]:n.SRC_ALPHA,[Wp]:n.SRC_ALPHA_SATURATE,[Gp]:n.DST_COLOR,[Hp]:n.DST_ALPHA,[zp]:n.ONE_MINUS_SRC_COLOR,[ia]:n.ONE_MINUS_SRC_ALPHA,[kp]:n.ONE_MINUS_DST_COLOR,[Vp]:n.ONE_MINUS_DST_ALPHA,[Xp]:n.CONSTANT_COLOR,[qp]:n.ONE_MINUS_CONSTANT_COLOR,[Yp]:n.CONSTANT_ALPHA,[$p]:n.ONE_MINUS_CONSTANT_ALPHA};function H(I,fe,de,Re,ce,re,De,ze,lt,et){if(I===jn){S===!0&&(_e(n.BLEND),S=!1);return}if(S===!1&&(se(n.BLEND),S=!0),I!==Dp){if(I!==m||et!==T){if((h!==_i||E!==_i)&&(n.blendEquation(n.FUNC_ADD),h=_i,E=_i),et)switch(I){case Ji:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case fc:n.blendFunc(n.ONE,n.ONE);break;case hc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case dc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case Ji:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case fc:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case hc:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case dc:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}w=null,b=null,R=null,C=null,L.set(0,0,0),F=0,m=I,T=et}return}ce=ce||fe,re=re||de,De=De||Re,(fe!==h||ce!==E)&&(n.blendEquationSeparate(A[fe],A[ce]),h=fe,E=ce),(de!==w||Re!==b||re!==R||De!==C)&&(n.blendFuncSeparate(g[de],g[Re],g[re],g[De]),w=de,b=Re,R=re,C=De),(ze.equals(L)===!1||lt!==F)&&(n.blendColor(ze.r,ze.g,ze.b,lt),L.copy(ze),F=lt),m=I,T=!1}function j(I,fe){I.side===jt?_e(n.CULL_FACE):se(n.CULL_FACE);let de=I.side===Bt;fe&&(de=!de),W(de),I.blending===Ji&&I.transparent===!1?H(jn):H(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),s.setMask(I.colorWrite);const Re=I.stencilWrite;a.setTest(Re),Re&&(a.setMask(I.stencilWriteMask),a.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),a.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Y(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?se(n.SAMPLE_ALPHA_TO_COVERAGE):_e(n.SAMPLE_ALPHA_TO_COVERAGE)}function W(I){y!==I&&(I?n.frontFace(n.CW):n.frontFace(n.CCW),y=I)}function O(I){I!==Rp?(se(n.CULL_FACE),I!==D&&(I===uc?n.cullFace(n.BACK):I===Cp?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):_e(n.CULL_FACE),D=I}function oe(I){I!==k&&(K&&n.lineWidth(I),k=I)}function Y(I,fe,de){I?(se(n.POLYGON_OFFSET_FILL),(q!==fe||Z!==de)&&(n.polygonOffset(fe,de),q=fe,Z=de)):_e(n.POLYGON_OFFSET_FILL)}function Q(I){I?se(n.SCISSOR_TEST):_e(n.SCISSOR_TEST)}function ie(I){I===void 0&&(I=n.TEXTURE0+te-1),he!==I&&(n.activeTexture(I),he=I)}function xe(I,fe,de){de===void 0&&(he===null?de=n.TEXTURE0+te-1:de=he);let Re=pe[de];Re===void 0&&(Re={type:void 0,texture:void 0},pe[de]=Re),(Re.type!==I||Re.texture!==fe)&&(he!==de&&(n.activeTexture(de),he=de),n.bindTexture(I,fe||ee[I]),Re.type=I,Re.texture=fe)}function x(){const I=pe[he];I!==void 0&&I.type!==void 0&&(n.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function _(){try{n.compressedTexImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function P(){try{n.compressedTexImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function V(){try{n.texSubImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function J(){try{n.texSubImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function G(){try{n.compressedTexSubImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Se(){try{n.compressedTexSubImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ae(){try{n.texStorage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ee(){try{n.texStorage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Te(){try{n.texImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function le(){try{n.texImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ve(I){Je.equals(I)===!1&&(n.scissor(I.x,I.y,I.z,I.w),Je.copy(I))}function Ce(I){Qe.equals(I)===!1&&(n.viewport(I.x,I.y,I.z,I.w),Qe.copy(I))}function be(I,fe){let de=c.get(fe);de===void 0&&(de=new WeakMap,c.set(fe,de));let Re=de.get(I);Re===void 0&&(Re=n.getUniformBlockIndex(fe,I.name),de.set(I,Re))}function me(I,fe){const Re=c.get(fe).get(I);l.get(fe)!==Re&&(n.uniformBlockBinding(fe,Re,I.__bindingPointIndex),l.set(fe,Re))}function Be(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},he=null,pe={},f={},d=new WeakMap,p=[],v=null,S=!1,m=null,h=null,w=null,b=null,E=null,R=null,C=null,L=new je(0,0,0),F=0,T=!1,y=null,D=null,k=null,q=null,Z=null,Je.set(0,0,n.canvas.width,n.canvas.height),Qe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:_e,bindFramebuffer:Le,drawBuffers:we,useProgram:We,setBlending:H,setMaterial:j,setFlipSided:W,setCullFace:O,setLineWidth:oe,setPolygonOffset:Y,setScissorTest:Q,activeTexture:ie,bindTexture:xe,unbindTexture:x,compressedTexImage2D:_,compressedTexImage3D:P,texImage2D:Te,texImage3D:le,updateUBOMapping:be,uniformBlockBinding:me,texStorage2D:ae,texStorage3D:Ee,texSubImage2D:V,texSubImage3D:J,compressedTexSubImage2D:G,compressedTexSubImage3D:Se,scissor:ve,viewport:Ce,reset:Be}}function Lx(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ze,u=new WeakMap;let f;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(x,_){return p?new OffscreenCanvas(x,_):Or("canvas")}function S(x,_,P){let V=1;const J=xe(x);if((J.width>P||J.height>P)&&(V=P/Math.max(J.width,J.height)),V<1)if(typeof HTMLImageElement<"u"&&x instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&x instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&x instanceof ImageBitmap||typeof VideoFrame<"u"&&x instanceof VideoFrame){const G=Math.floor(V*J.width),Se=Math.floor(V*J.height);f===void 0&&(f=v(G,Se));const ae=_?v(G,Se):f;return ae.width=G,ae.height=Se,ae.getContext("2d").drawImage(x,0,0,G,Se),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+G+"x"+Se+")."),ae}else return"data"in x&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),x;return x}function m(x){return x.generateMipmaps}function h(x){n.generateMipmap(x)}function w(x){return x.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:x.isWebGL3DRenderTarget?n.TEXTURE_3D:x.isWebGLArrayRenderTarget||x.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function b(x,_,P,V,J=!1){if(x!==null){if(n[x]!==void 0)return n[x];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+x+"'")}let G=_;if(_===n.RED&&(P===n.FLOAT&&(G=n.R32F),P===n.HALF_FLOAT&&(G=n.R16F),P===n.UNSIGNED_BYTE&&(G=n.R8)),_===n.RED_INTEGER&&(P===n.UNSIGNED_BYTE&&(G=n.R8UI),P===n.UNSIGNED_SHORT&&(G=n.R16UI),P===n.UNSIGNED_INT&&(G=n.R32UI),P===n.BYTE&&(G=n.R8I),P===n.SHORT&&(G=n.R16I),P===n.INT&&(G=n.R32I)),_===n.RG&&(P===n.FLOAT&&(G=n.RG32F),P===n.HALF_FLOAT&&(G=n.RG16F),P===n.UNSIGNED_BYTE&&(G=n.RG8)),_===n.RG_INTEGER&&(P===n.UNSIGNED_BYTE&&(G=n.RG8UI),P===n.UNSIGNED_SHORT&&(G=n.RG16UI),P===n.UNSIGNED_INT&&(G=n.RG32UI),P===n.BYTE&&(G=n.RG8I),P===n.SHORT&&(G=n.RG16I),P===n.INT&&(G=n.RG32I)),_===n.RGB_INTEGER&&(P===n.UNSIGNED_BYTE&&(G=n.RGB8UI),P===n.UNSIGNED_SHORT&&(G=n.RGB16UI),P===n.UNSIGNED_INT&&(G=n.RGB32UI),P===n.BYTE&&(G=n.RGB8I),P===n.SHORT&&(G=n.RGB16I),P===n.INT&&(G=n.RGB32I)),_===n.RGBA_INTEGER&&(P===n.UNSIGNED_BYTE&&(G=n.RGBA8UI),P===n.UNSIGNED_SHORT&&(G=n.RGBA16UI),P===n.UNSIGNED_INT&&(G=n.RGBA32UI),P===n.BYTE&&(G=n.RGBA8I),P===n.SHORT&&(G=n.RGBA16I),P===n.INT&&(G=n.RGBA32I)),_===n.RGB&&(P===n.UNSIGNED_INT_5_9_9_9_REV&&(G=n.RGB9_E5),P===n.UNSIGNED_INT_10F_11F_11F_REV&&(G=n.R11F_G11F_B10F)),_===n.RGBA){const Se=J?Fs:Ke.getTransfer(V);P===n.FLOAT&&(G=n.RGBA32F),P===n.HALF_FLOAT&&(G=n.RGBA16F),P===n.UNSIGNED_BYTE&&(G=Se===rt?n.SRGB8_ALPHA8:n.RGBA8),P===n.UNSIGNED_SHORT_4_4_4_4&&(G=n.RGBA4),P===n.UNSIGNED_SHORT_5_5_5_1&&(G=n.RGB5_A1)}return(G===n.R16F||G===n.R32F||G===n.RG16F||G===n.RG32F||G===n.RGBA16F||G===n.RGBA32F)&&e.get("EXT_color_buffer_float"),G}function E(x,_){let P;return x?_===null||_===yi||_===Ur?P=n.DEPTH24_STENCIL8:_===Un?P=n.DEPTH32F_STENCIL8:_===Ir&&(P=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===yi||_===Ur?P=n.DEPTH_COMPONENT24:_===Un?P=n.DEPTH_COMPONENT32F:_===Ir&&(P=n.DEPTH_COMPONENT16),P}function R(x,_){return m(x)===!0||x.isFramebufferTexture&&x.minFilter!==an&&x.minFilter!==pn?Math.log2(Math.max(_.width,_.height))+1:x.mipmaps!==void 0&&x.mipmaps.length>0?x.mipmaps.length:x.isCompressedTexture&&Array.isArray(x.image)?_.mipmaps.length:1}function C(x){const _=x.target;_.removeEventListener("dispose",C),F(_),_.isVideoTexture&&u.delete(_)}function L(x){const _=x.target;_.removeEventListener("dispose",L),y(_)}function F(x){const _=i.get(x);if(_.__webglInit===void 0)return;const P=x.source,V=d.get(P);if(V){const J=V[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&T(x),Object.keys(V).length===0&&d.delete(P)}i.remove(x)}function T(x){const _=i.get(x);n.deleteTexture(_.__webglTexture);const P=x.source,V=d.get(P);delete V[_.__cacheKey],o.memory.textures--}function y(x){const _=i.get(x);if(x.depthTexture&&(x.depthTexture.dispose(),i.remove(x.depthTexture)),x.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(_.__webglFramebuffer[V]))for(let J=0;J<_.__webglFramebuffer[V].length;J++)n.deleteFramebuffer(_.__webglFramebuffer[V][J]);else n.deleteFramebuffer(_.__webglFramebuffer[V]);_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer[V])}else{if(Array.isArray(_.__webglFramebuffer))for(let V=0;V<_.__webglFramebuffer.length;V++)n.deleteFramebuffer(_.__webglFramebuffer[V]);else n.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&n.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&n.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let V=0;V<_.__webglColorRenderbuffer.length;V++)_.__webglColorRenderbuffer[V]&&n.deleteRenderbuffer(_.__webglColorRenderbuffer[V]);_.__webglDepthRenderbuffer&&n.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const P=x.textures;for(let V=0,J=P.length;V<J;V++){const G=i.get(P[V]);G.__webglTexture&&(n.deleteTexture(G.__webglTexture),o.memory.textures--),i.remove(P[V])}i.remove(x)}let D=0;function k(){D=0}function q(){const x=D;return x>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+x+" texture units while this GPU supports only "+r.maxTextures),D+=1,x}function Z(x){const _=[];return _.push(x.wrapS),_.push(x.wrapT),_.push(x.wrapR||0),_.push(x.magFilter),_.push(x.minFilter),_.push(x.anisotropy),_.push(x.internalFormat),_.push(x.format),_.push(x.type),_.push(x.generateMipmaps),_.push(x.premultiplyAlpha),_.push(x.flipY),_.push(x.unpackAlignment),_.push(x.colorSpace),_.join()}function te(x,_){const P=i.get(x);if(x.isVideoTexture&&Q(x),x.isRenderTargetTexture===!1&&x.isExternalTexture!==!0&&x.version>0&&P.__version!==x.version){const V=x.image;if(V===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ee(P,x,_);return}}else x.isExternalTexture&&(P.__webglTexture=x.sourceTexture?x.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,P.__webglTexture,n.TEXTURE0+_)}function K(x,_){const P=i.get(x);if(x.isRenderTargetTexture===!1&&x.version>0&&P.__version!==x.version){ee(P,x,_);return}t.bindTexture(n.TEXTURE_2D_ARRAY,P.__webglTexture,n.TEXTURE0+_)}function ne(x,_){const P=i.get(x);if(x.isRenderTargetTexture===!1&&x.version>0&&P.__version!==x.version){ee(P,x,_);return}t.bindTexture(n.TEXTURE_3D,P.__webglTexture,n.TEXTURE0+_)}function z(x,_){const P=i.get(x);if(x.version>0&&P.__version!==x.version){se(P,x,_);return}t.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+_)}const he={[da]:n.REPEAT,[xi]:n.CLAMP_TO_EDGE,[pa]:n.MIRRORED_REPEAT},pe={[an]:n.NEAREST,[rm]:n.NEAREST_MIPMAP_NEAREST,[Jr]:n.NEAREST_MIPMAP_LINEAR,[pn]:n.LINEAR,[uo]:n.LINEAR_MIPMAP_NEAREST,[Mi]:n.LINEAR_MIPMAP_LINEAR},ye={[lm]:n.NEVER,[pm]:n.ALWAYS,[cm]:n.LESS,[Cf]:n.LEQUAL,[um]:n.EQUAL,[dm]:n.GEQUAL,[fm]:n.GREATER,[hm]:n.NOTEQUAL};function Ue(x,_){if(_.type===Un&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===pn||_.magFilter===uo||_.magFilter===Jr||_.magFilter===Mi||_.minFilter===pn||_.minFilter===uo||_.minFilter===Jr||_.minFilter===Mi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(x,n.TEXTURE_WRAP_S,he[_.wrapS]),n.texParameteri(x,n.TEXTURE_WRAP_T,he[_.wrapT]),(x===n.TEXTURE_3D||x===n.TEXTURE_2D_ARRAY)&&n.texParameteri(x,n.TEXTURE_WRAP_R,he[_.wrapR]),n.texParameteri(x,n.TEXTURE_MAG_FILTER,pe[_.magFilter]),n.texParameteri(x,n.TEXTURE_MIN_FILTER,pe[_.minFilter]),_.compareFunction&&(n.texParameteri(x,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(x,n.TEXTURE_COMPARE_FUNC,ye[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===an||_.minFilter!==Jr&&_.minFilter!==Mi||_.type===Un&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){const P=e.get("EXT_texture_filter_anisotropic");n.texParameterf(x,P.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function Je(x,_){let P=!1;x.__webglInit===void 0&&(x.__webglInit=!0,_.addEventListener("dispose",C));const V=_.source;let J=d.get(V);J===void 0&&(J={},d.set(V,J));const G=Z(_);if(G!==x.__cacheKey){J[G]===void 0&&(J[G]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,P=!0),J[G].usedTimes++;const Se=J[x.__cacheKey];Se!==void 0&&(J[x.__cacheKey].usedTimes--,Se.usedTimes===0&&T(_)),x.__cacheKey=G,x.__webglTexture=J[G].texture}return P}function Qe(x,_,P){return Math.floor(Math.floor(x/P)/_)}function Ye(x,_,P,V){const G=x.updateRanges;if(G.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,_.width,_.height,P,V,_.data);else{G.sort((le,ve)=>le.start-ve.start);let Se=0;for(let le=1;le<G.length;le++){const ve=G[Se],Ce=G[le],be=ve.start+ve.count,me=Qe(Ce.start,_.width,4),Be=Qe(ve.start,_.width,4);Ce.start<=be+1&&me===Be&&Qe(Ce.start+Ce.count-1,_.width,4)===me?ve.count=Math.max(ve.count,Ce.start+Ce.count-ve.start):(++Se,G[Se]=Ce)}G.length=Se+1;const ae=n.getParameter(n.UNPACK_ROW_LENGTH),Ee=n.getParameter(n.UNPACK_SKIP_PIXELS),Te=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,_.width);for(let le=0,ve=G.length;le<ve;le++){const Ce=G[le],be=Math.floor(Ce.start/4),me=Math.ceil(Ce.count/4),Be=be%_.width,I=Math.floor(be/_.width),fe=me,de=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,Be),n.pixelStorei(n.UNPACK_SKIP_ROWS,I),t.texSubImage2D(n.TEXTURE_2D,0,Be,I,fe,de,P,V,_.data)}x.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,ae),n.pixelStorei(n.UNPACK_SKIP_PIXELS,Ee),n.pixelStorei(n.UNPACK_SKIP_ROWS,Te)}}function ee(x,_,P){let V=n.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(V=n.TEXTURE_2D_ARRAY),_.isData3DTexture&&(V=n.TEXTURE_3D);const J=Je(x,_),G=_.source;t.bindTexture(V,x.__webglTexture,n.TEXTURE0+P);const Se=i.get(G);if(G.version!==Se.__version||J===!0){t.activeTexture(n.TEXTURE0+P);const ae=Ke.getPrimaries(Ke.workingColorSpace),Ee=_.colorSpace===Yn?null:Ke.getPrimaries(_.colorSpace),Te=_.colorSpace===Yn||ae===Ee?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);let le=S(_.image,!1,r.maxTextureSize);le=ie(_,le);const ve=s.convert(_.format,_.colorSpace),Ce=s.convert(_.type);let be=b(_.internalFormat,ve,Ce,_.colorSpace,_.isVideoTexture);Ue(V,_);let me;const Be=_.mipmaps,I=_.isVideoTexture!==!0,fe=Se.__version===void 0||J===!0,de=G.dataReady,Re=R(_,le);if(_.isDepthTexture)be=E(_.format===Fr,_.type),fe&&(I?t.texStorage2D(n.TEXTURE_2D,1,be,le.width,le.height):t.texImage2D(n.TEXTURE_2D,0,be,le.width,le.height,0,ve,Ce,null));else if(_.isDataTexture)if(Be.length>0){I&&fe&&t.texStorage2D(n.TEXTURE_2D,Re,be,Be[0].width,Be[0].height);for(let ce=0,re=Be.length;ce<re;ce++)me=Be[ce],I?de&&t.texSubImage2D(n.TEXTURE_2D,ce,0,0,me.width,me.height,ve,Ce,me.data):t.texImage2D(n.TEXTURE_2D,ce,be,me.width,me.height,0,ve,Ce,me.data);_.generateMipmaps=!1}else I?(fe&&t.texStorage2D(n.TEXTURE_2D,Re,be,le.width,le.height),de&&Ye(_,le,ve,Ce)):t.texImage2D(n.TEXTURE_2D,0,be,le.width,le.height,0,ve,Ce,le.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){I&&fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Re,be,Be[0].width,Be[0].height,le.depth);for(let ce=0,re=Be.length;ce<re;ce++)if(me=Be[ce],_.format!==rn)if(ve!==null)if(I){if(de)if(_.layerUpdates.size>0){const De=Oc(me.width,me.height,_.format,_.type);for(const ze of _.layerUpdates){const lt=me.data.subarray(ze*De/me.data.BYTES_PER_ELEMENT,(ze+1)*De/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ce,0,0,ze,me.width,me.height,1,ve,lt)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ce,0,0,0,me.width,me.height,le.depth,ve,me.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ce,be,me.width,me.height,le.depth,0,me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?de&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ce,0,0,0,me.width,me.height,le.depth,ve,Ce,me.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ce,be,me.width,me.height,le.depth,0,ve,Ce,me.data)}else{I&&fe&&t.texStorage2D(n.TEXTURE_2D,Re,be,Be[0].width,Be[0].height);for(let ce=0,re=Be.length;ce<re;ce++)me=Be[ce],_.format!==rn?ve!==null?I?de&&t.compressedTexSubImage2D(n.TEXTURE_2D,ce,0,0,me.width,me.height,ve,me.data):t.compressedTexImage2D(n.TEXTURE_2D,ce,be,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?de&&t.texSubImage2D(n.TEXTURE_2D,ce,0,0,me.width,me.height,ve,Ce,me.data):t.texImage2D(n.TEXTURE_2D,ce,be,me.width,me.height,0,ve,Ce,me.data)}else if(_.isDataArrayTexture)if(I){if(fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Re,be,le.width,le.height,le.depth),de)if(_.layerUpdates.size>0){const ce=Oc(le.width,le.height,_.format,_.type);for(const re of _.layerUpdates){const De=le.data.subarray(re*ce/le.data.BYTES_PER_ELEMENT,(re+1)*ce/le.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,re,le.width,le.height,1,ve,Ce,De)}_.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,le.width,le.height,le.depth,ve,Ce,le.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,be,le.width,le.height,le.depth,0,ve,Ce,le.data);else if(_.isData3DTexture)I?(fe&&t.texStorage3D(n.TEXTURE_3D,Re,be,le.width,le.height,le.depth),de&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,le.width,le.height,le.depth,ve,Ce,le.data)):t.texImage3D(n.TEXTURE_3D,0,be,le.width,le.height,le.depth,0,ve,Ce,le.data);else if(_.isFramebufferTexture){if(fe)if(I)t.texStorage2D(n.TEXTURE_2D,Re,be,le.width,le.height);else{let ce=le.width,re=le.height;for(let De=0;De<Re;De++)t.texImage2D(n.TEXTURE_2D,De,be,ce,re,0,ve,Ce,null),ce>>=1,re>>=1}}else if(Be.length>0){if(I&&fe){const ce=xe(Be[0]);t.texStorage2D(n.TEXTURE_2D,Re,be,ce.width,ce.height)}for(let ce=0,re=Be.length;ce<re;ce++)me=Be[ce],I?de&&t.texSubImage2D(n.TEXTURE_2D,ce,0,0,ve,Ce,me):t.texImage2D(n.TEXTURE_2D,ce,be,ve,Ce,me);_.generateMipmaps=!1}else if(I){if(fe){const ce=xe(le);t.texStorage2D(n.TEXTURE_2D,Re,be,ce.width,ce.height)}de&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Ce,le)}else t.texImage2D(n.TEXTURE_2D,0,be,ve,Ce,le);m(_)&&h(V),Se.__version=G.version,_.onUpdate&&_.onUpdate(_)}x.__version=_.version}function se(x,_,P){if(_.image.length!==6)return;const V=Je(x,_),J=_.source;t.bindTexture(n.TEXTURE_CUBE_MAP,x.__webglTexture,n.TEXTURE0+P);const G=i.get(J);if(J.version!==G.__version||V===!0){t.activeTexture(n.TEXTURE0+P);const Se=Ke.getPrimaries(Ke.workingColorSpace),ae=_.colorSpace===Yn?null:Ke.getPrimaries(_.colorSpace),Ee=_.colorSpace===Yn||Se===ae?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,_.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,_.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const Te=_.isCompressedTexture||_.image[0].isCompressedTexture,le=_.image[0]&&_.image[0].isDataTexture,ve=[];for(let re=0;re<6;re++)!Te&&!le?ve[re]=S(_.image[re],!0,r.maxCubemapSize):ve[re]=le?_.image[re].image:_.image[re],ve[re]=ie(_,ve[re]);const Ce=ve[0],be=s.convert(_.format,_.colorSpace),me=s.convert(_.type),Be=b(_.internalFormat,be,me,_.colorSpace),I=_.isVideoTexture!==!0,fe=G.__version===void 0||V===!0,de=J.dataReady;let Re=R(_,Ce);Ue(n.TEXTURE_CUBE_MAP,_);let ce;if(Te){I&&fe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,Be,Ce.width,Ce.height);for(let re=0;re<6;re++){ce=ve[re].mipmaps;for(let De=0;De<ce.length;De++){const ze=ce[De];_.format!==rn?be!==null?I?de&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De,0,0,ze.width,ze.height,be,ze.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De,Be,ze.width,ze.height,0,ze.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De,0,0,ze.width,ze.height,be,me,ze.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De,Be,ze.width,ze.height,0,be,me,ze.data)}}}else{if(ce=_.mipmaps,I&&fe){ce.length>0&&Re++;const re=xe(ve[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,Be,re.width,re.height)}for(let re=0;re<6;re++)if(le){I?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,ve[re].width,ve[re].height,be,me,ve[re].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Be,ve[re].width,ve[re].height,0,be,me,ve[re].data);for(let De=0;De<ce.length;De++){const lt=ce[De].image[re].image;I?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De+1,0,0,lt.width,lt.height,be,me,lt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De+1,Be,lt.width,lt.height,0,be,me,lt.data)}}else{I?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,be,me,ve[re]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Be,be,me,ve[re]);for(let De=0;De<ce.length;De++){const ze=ce[De];I?de&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De+1,0,0,be,me,ze.image[re]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+re,De+1,Be,be,me,ze.image[re])}}}m(_)&&h(n.TEXTURE_CUBE_MAP),G.__version=J.version,_.onUpdate&&_.onUpdate(_)}x.__version=_.version}function _e(x,_,P,V,J,G){const Se=s.convert(P.format,P.colorSpace),ae=s.convert(P.type),Ee=b(P.internalFormat,Se,ae,P.colorSpace),Te=i.get(_),le=i.get(P);if(le.__renderTarget=_,!Te.__hasExternalTextures){const ve=Math.max(1,_.width>>G),Ce=Math.max(1,_.height>>G);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?t.texImage3D(J,G,Ee,ve,Ce,_.depth,0,Se,ae,null):t.texImage2D(J,G,Ee,ve,Ce,0,Se,ae,null)}t.bindFramebuffer(n.FRAMEBUFFER,x),Y(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,V,J,le.__webglTexture,0,oe(_)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,V,J,le.__webglTexture,G),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Le(x,_,P){if(n.bindRenderbuffer(n.RENDERBUFFER,x),_.depthBuffer){const V=_.depthTexture,J=V&&V.isDepthTexture?V.type:null,G=E(_.stencilBuffer,J),Se=_.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=oe(_);Y(_)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ae,G,_.width,_.height):P?n.renderbufferStorageMultisample(n.RENDERBUFFER,ae,G,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,G,_.width,_.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Se,n.RENDERBUFFER,x)}else{const V=_.textures;for(let J=0;J<V.length;J++){const G=V[J],Se=s.convert(G.format,G.colorSpace),ae=s.convert(G.type),Ee=b(G.internalFormat,Se,ae,G.colorSpace),Te=oe(_);P&&Y(_)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Te,Ee,_.width,_.height):Y(_)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Te,Ee,_.width,_.height):n.renderbufferStorage(n.RENDERBUFFER,Ee,_.width,_.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function we(x,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,x),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const V=i.get(_.depthTexture);V.__renderTarget=_,(!V.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),te(_.depthTexture,0);const J=V.__webglTexture,G=oe(_);if(_.depthTexture.format===Nr)Y(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,J,0,G):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,J,0);else if(_.depthTexture.format===Fr)Y(_)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,J,0,G):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function We(x){const _=i.get(x),P=x.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==x.depthTexture){const V=x.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),V){const J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,V.removeEventListener("dispose",J)};V.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=V}if(x.depthTexture&&!_.__autoAllocateDepthBuffer){if(P)throw new Error("target.depthTexture not supported in Cube render targets");const V=x.texture.mipmaps;V&&V.length>0?we(_.__webglFramebuffer[0],x):we(_.__webglFramebuffer,x)}else if(P){_.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[V]),_.__webglDepthbuffer[V]===void 0)_.__webglDepthbuffer[V]=n.createRenderbuffer(),Le(_.__webglDepthbuffer[V],x,!1);else{const J=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,G=_.__webglDepthbuffer[V];n.bindRenderbuffer(n.RENDERBUFFER,G),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,G)}}else{const V=x.texture.mipmaps;if(V&&V.length>0?t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=n.createRenderbuffer(),Le(_.__webglDepthbuffer,x,!1);else{const J=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,G=_.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,G),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,G)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function A(x,_,P){const V=i.get(x);_!==void 0&&_e(V.__webglFramebuffer,x,x.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),P!==void 0&&We(x)}function g(x){const _=x.texture,P=i.get(x),V=i.get(_);x.addEventListener("dispose",L);const J=x.textures,G=x.isWebGLCubeRenderTarget===!0,Se=J.length>1;if(Se||(V.__webglTexture===void 0&&(V.__webglTexture=n.createTexture()),V.__version=_.version,o.memory.textures++),G){P.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0){P.__webglFramebuffer[ae]=[];for(let Ee=0;Ee<_.mipmaps.length;Ee++)P.__webglFramebuffer[ae][Ee]=n.createFramebuffer()}else P.__webglFramebuffer[ae]=n.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){P.__webglFramebuffer=[];for(let ae=0;ae<_.mipmaps.length;ae++)P.__webglFramebuffer[ae]=n.createFramebuffer()}else P.__webglFramebuffer=n.createFramebuffer();if(Se)for(let ae=0,Ee=J.length;ae<Ee;ae++){const Te=i.get(J[ae]);Te.__webglTexture===void 0&&(Te.__webglTexture=n.createTexture(),o.memory.textures++)}if(x.samples>0&&Y(x)===!1){P.__webglMultisampledFramebuffer=n.createFramebuffer(),P.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let ae=0;ae<J.length;ae++){const Ee=J[ae];P.__webglColorRenderbuffer[ae]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,P.__webglColorRenderbuffer[ae]);const Te=s.convert(Ee.format,Ee.colorSpace),le=s.convert(Ee.type),ve=b(Ee.internalFormat,Te,le,Ee.colorSpace,x.isXRRenderTarget===!0),Ce=oe(x);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ce,ve,x.width,x.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ae,n.RENDERBUFFER,P.__webglColorRenderbuffer[ae])}n.bindRenderbuffer(n.RENDERBUFFER,null),x.depthBuffer&&(P.__webglDepthRenderbuffer=n.createRenderbuffer(),Le(P.__webglDepthRenderbuffer,x,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(G){t.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture),Ue(n.TEXTURE_CUBE_MAP,_);for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0)for(let Ee=0;Ee<_.mipmaps.length;Ee++)_e(P.__webglFramebuffer[ae][Ee],x,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Ee);else _e(P.__webglFramebuffer[ae],x,_,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(_)&&h(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Se){for(let ae=0,Ee=J.length;ae<Ee;ae++){const Te=J[ae],le=i.get(Te);let ve=n.TEXTURE_2D;(x.isWebGL3DRenderTarget||x.isWebGLArrayRenderTarget)&&(ve=x.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ve,le.__webglTexture),Ue(ve,Te),_e(P.__webglFramebuffer,x,Te,n.COLOR_ATTACHMENT0+ae,ve,0),m(Te)&&h(ve)}t.unbindTexture()}else{let ae=n.TEXTURE_2D;if((x.isWebGL3DRenderTarget||x.isWebGLArrayRenderTarget)&&(ae=x.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ae,V.__webglTexture),Ue(ae,_),_.mipmaps&&_.mipmaps.length>0)for(let Ee=0;Ee<_.mipmaps.length;Ee++)_e(P.__webglFramebuffer[Ee],x,_,n.COLOR_ATTACHMENT0,ae,Ee);else _e(P.__webglFramebuffer,x,_,n.COLOR_ATTACHMENT0,ae,0);m(_)&&h(ae),t.unbindTexture()}x.depthBuffer&&We(x)}function H(x){const _=x.textures;for(let P=0,V=_.length;P<V;P++){const J=_[P];if(m(J)){const G=w(x),Se=i.get(J).__webglTexture;t.bindTexture(G,Se),h(G),t.unbindTexture()}}}const j=[],W=[];function O(x){if(x.samples>0){if(Y(x)===!1){const _=x.textures,P=x.width,V=x.height;let J=n.COLOR_BUFFER_BIT;const G=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Se=i.get(x),ae=_.length>1;if(ae)for(let Te=0;Te<_.length;Te++)t.bindFramebuffer(n.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Se.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Se.__webglMultisampledFramebuffer);const Ee=x.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Se.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Se.__webglFramebuffer);for(let Te=0;Te<_.length;Te++){if(x.resolveDepthBuffer&&(x.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),x.stencilBuffer&&x.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),ae){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Se.__webglColorRenderbuffer[Te]);const le=i.get(_[Te]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,le,0)}n.blitFramebuffer(0,0,P,V,0,0,P,V,J,n.NEAREST),l===!0&&(j.length=0,W.length=0,j.push(n.COLOR_ATTACHMENT0+Te),x.depthBuffer&&x.resolveDepthBuffer===!1&&(j.push(G),W.push(G),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,W)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,j))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ae)for(let Te=0;Te<_.length;Te++){t.bindFramebuffer(n.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.RENDERBUFFER,Se.__webglColorRenderbuffer[Te]);const le=i.get(_[Te]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Se.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.TEXTURE_2D,le,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Se.__webglMultisampledFramebuffer)}else if(x.depthBuffer&&x.resolveDepthBuffer===!1&&l){const _=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[_])}}}function oe(x){return Math.min(r.maxSamples,x.samples)}function Y(x){const _=i.get(x);return x.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function Q(x){const _=o.render.frame;u.get(x)!==_&&(u.set(x,_),x.update())}function ie(x,_){const P=x.colorSpace,V=x.format,J=x.type;return x.isCompressedTexture===!0||x.isVideoTexture===!0||P!==sr&&P!==Yn&&(Ke.getTransfer(P)===rt?(V!==rn||J!==Mn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",P)),_}function xe(x){return typeof HTMLImageElement<"u"&&x instanceof HTMLImageElement?(c.width=x.naturalWidth||x.width,c.height=x.naturalHeight||x.height):typeof VideoFrame<"u"&&x instanceof VideoFrame?(c.width=x.displayWidth,c.height=x.displayHeight):(c.width=x.width,c.height=x.height),c}this.allocateTextureUnit=q,this.resetTextureUnits=k,this.setTexture2D=te,this.setTexture2DArray=K,this.setTexture3D=ne,this.setTextureCube=z,this.rebindTextures=A,this.setupRenderTarget=g,this.updateRenderTargetMipmap=H,this.updateMultisampleRenderTarget=O,this.setupDepthRenderbuffer=We,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=Y}function Ix(n,e){function t(i,r=Yn){let s;const o=Ke.getTransfer(r);if(i===Mn)return n.UNSIGNED_BYTE;if(i===dl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===pl)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Ef)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===yf)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Mf)return n.BYTE;if(i===Sf)return n.SHORT;if(i===Ir)return n.UNSIGNED_SHORT;if(i===hl)return n.INT;if(i===yi)return n.UNSIGNED_INT;if(i===Un)return n.FLOAT;if(i===Vr)return n.HALF_FLOAT;if(i===Tf)return n.ALPHA;if(i===bf)return n.RGB;if(i===rn)return n.RGBA;if(i===Nr)return n.DEPTH_COMPONENT;if(i===Fr)return n.DEPTH_STENCIL;if(i===Af)return n.RED;if(i===ml)return n.RED_INTEGER;if(i===wf)return n.RG;if(i===gl)return n.RG_INTEGER;if(i===_l)return n.RGBA_INTEGER;if(i===Ts||i===bs||i===As||i===ws)if(o===rt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ts)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===As)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ws)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ts)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===bs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===As)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ws)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===ma||i===ga||i===_a||i===va)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===ma)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===ga)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===_a)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===va)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===xa||i===Ma||i===Sa)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===xa||i===Ma)return o===rt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Sa)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Ea||i===ya||i===Ta||i===ba||i===Aa||i===wa||i===Ra||i===Ca||i===Pa||i===Da||i===La||i===Ia||i===Ua||i===Na)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Ea)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===ya)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Ta)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ba)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Aa)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===wa)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ra)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ca)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Pa)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Da)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===La)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ia)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ua)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Na)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Fa||i===Oa||i===Ba)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Fa)return o===rt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Oa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Ba)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===za||i===Ha||i===Va||i===Ga)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===za)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Ha)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Va)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Ga)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ur?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const Ux=`
void main() {
...
}`;class Fx{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Hf(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new ei({vertexShader:Ux,fragmentShader:Nx,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Lt(new qr(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Ox extends Ai{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,d=null,p=null,v=null;const S=typeof XRWebGLBinding<"u",m=new Fx,h={},w=t.getContextAttributes();let b=null,E=null;const R=[],C=[],L=new Ze;let F=null;const T=new Wt;T.viewport=new st;const y=new Wt;y.viewport=new st;const D=[T,y],k=new rg;let q=null,Z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ee){let se=R[ee];return se===void 0&&(se=new Io,R[ee]=se),se.getTargetRaySpace()},this.getControllerGrip=function(ee){let se=R[ee];return se===void 0&&(se=new Io,R[ee]=se),se.getGripSpace()},this.getHand=function(ee){let se=R[ee];return se===void 0&&(se=new Io,R[ee]=se),se.getHandSpace()};function te(ee){const se=C.indexOf(ee.inputSource);if(se===-1)return;const _e=R[se];_e!==void 0&&(_e.update(ee.inputSource,ee.frame,c||o),_e.dispatchEvent({type:ee.type,data:ee.inputSource}))}function K(){r.removeEventListener("select",te),r.removeEventListener("selectstart",te),r.removeEventListener("selectend",te),r.removeEventListener("squeeze",te),r.removeEventListener("squeezestart",te),r.removeEventListener("squeezeend",te),r.removeEventListener("end",K),r.removeEventListener("inputsourceschange",ne);for(let ee=0;ee<R.length;ee++){const se=C[ee];se!==null&&(C[ee]=null,R[ee].disconnect(se))}q=null,Z=null,m.reset();for(const ee in h)delete h[ee];e.setRenderTarget(b),p=null,d=null,f=null,r=null,E=null,Ye.stop(),i.isPresenting=!1,e.setPixelRatio(F),e.setSize(L.width,L.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ee){s=ee,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ee){a=ee,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(ee){c=ee},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return f===null&&S&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(ee){if(r=ee,r!==null){if(b=e.getRenderTarget(),r.addEventListener("select",te),r.addEventListener("selectstart",te),r.addEventListener("selectend",te),r.addEventListener("squeeze",te),r.addEventListener("squeezestart",te),r.addEventListener("squeezeend",te),r.addEventListener("end",K),r.addEventListener("inputsourceschange",ne),w.xrCompatible!==!0&&await t.makeXRCompatible(),F=e.getPixelRatio(),e.getSize(L),S&&"createProjectionLayer"in XRWebGLBinding.prototype){let _e=null,Le=null,we=null;w.depth&&(we=w.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,_e=w.stencil?Fr:Nr,Le=w.stencil?Ur:yi);const We={colorFormat:t.RGBA8,depthFormat:we,scaleFactor:s};f=this.getBinding(),d=f.createProjectionLayer(We),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),E=new Ti(d.textureWidth,d.textureHeight,{format:rn,type:Mn,depthTexture:new zf(d.textureWidth,d.textureHeight,Le,void 0,void 0,void 0,void 0,void 0,void 0,_e),stencilBuffer:w.stencil,colorSpace:e.outputColorSpace,samples:w.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const _e={antialias:w.antialias,alpha:!0,depth:w.depth,stencil:w.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,_e),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),E=new Ti(p.framebufferWidth,p.framebufferHeight,{format:rn,type:Mn,colorSpace:e.outputColorSpace,stencilBuffer:w.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Ye.setContext(r),Ye.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function ne(ee){for(let se=0;se<ee.removed.length;se++){const _e=ee.removed[se],Le=C.indexOf(_e);Le>=0&&(C[Le]=null,R[Le].disconnect(_e))}for(let se=0;se<ee.added.length;se++){const _e=ee.added[se];let Le=C.indexOf(_e);if(Le===-1){for(let We=0;We<R.length;We++)if(We>=C.length){C.push(_e),Le=We;break}else if(C[We]===null){C[We]=_e,Le=We;break}if(Le===-1)break}const we=R[Le];we&&we.connect(_e)}}const z=new B,he=new B;function pe(ee,se,_e){z.setFromMatrixPosition(se.matrixWorld),he.setFromMatrixPosition(_e.matrixWorld);const Le=z.distanceTo(he),we=se.projectionMatrix.elements,We=_e.projectionMatrix.elements,A=we[14]/(we[10]-1),g=we[14]/(we[10]+1),H=(we[9]+1)/we[5],j=(we[9]-1)/we[5],W=(we[8]-1)/we[0],O=(We[8]+1)/We[0],oe=A*W,Y=A*O,Q=Le/(-W+O),ie=Q*-W;if(se.matrixWorld.decompose(ee.position,ee.quaternion,ee.scale),ee.translateX(ie),ee.translateZ(Q),ee.matrixWorld.compose(ee.position,ee.quaternion,ee.scale),ee.matrixWorldInverse.copy(ee.matrixWorld).invert(),we[10]===-1)ee.projectionMatrix.copy(se.projectionMatrix),ee.projectionMatrixInverse.copy(se.projectionMatrixInverse);else{const xe=A+Q,x=g+Q,_=oe-ie,P=Y+(Le-ie),V=H*g/x*xe,J=j*g/x*xe;ee.projectionMatrix.makePerspective(_,P,V,J,xe,x),ee.projectionMatrixInverse.copy(ee.projectionMatrix).invert()}}function ye(ee,se){se===null?ee.matrixWorld.copy(ee.matrix):ee.matrixWorld.multiplyMatrices(se.matrixWorld,ee.matrix),ee.matrixWorldInverse.copy(ee.matrixWorld).invert()}this.updateCamera=function(ee){if(r===null)return;let se=ee.near,_e=ee.far;m.texture!==null&&(m.depthNear>0&&(se=m.depthNear),m.depthFar>0&&(_e=m.depthFar)),k.near=y.near=T.near=se,k.far=y.far=T.far=_e,(q!==k.near||Z!==k.far)&&(r.updateRenderState({depthNear:k.near,depthFar:k.far}),q=k.near,Z=k.far),k.layers.mask=ee.layers.mask|6,T.layers.mask=k.layers.mask&3,y.layers.mask=k.layers.mask&5;const Le=ee.parent,we=k.cameras;ye(k,Le);for(let We=0;We<we.length;We++)ye(we[We],Le);we.length===2?pe(k,T,y):k.projectionMatrix.copy(T.projectionMatrix),Ue(ee,k,Le)};function Ue(ee,se,_e){_e===null?ee.matrix.copy(se.matrixWorld):(ee.matrix.copy(_e.matrixWorld),ee.matrix.invert(),ee.matrix.multiply(se.matrixWorld)),ee.matrix.decompose(ee.position,ee.quaternion,ee.scale),ee.updateMatrixWorld(!0),ee.projectionMatrix.copy(se.projectionMatrix),ee.projectionMatrixInverse.copy(se.projectionMatrixInverse),ee.isPerspectiveCamera&&(ee.fov=ka*2*Math.atan(1/ee.projectionMatrix.elements[5]),ee.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(ee){l=ee,d!==null&&(d.fixedFoveation=ee),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=ee)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(k)},this.getCameraTexture=function(ee){return h[ee]};let Je=null;function Qe(ee,se){if(u=se.getViewerPose(c||o),v=se,u!==null){const _e=u.views;p!==null&&(e.setRenderTargetFramebuffer(E,p.framebuffer),e.setRenderTarget(E));let Le=!1;_e.length!==k.cameras.length&&(k.cameras.length=0,Le=!0);for(let g=0;g<_e.length;g++){const H=_e[g];let j=null;if(p!==null)j=p.getViewport(H);else{const O=f.getViewSubImage(d,H);j=O.viewport,g===0&&(e.setRenderTargetTextures(E,O.colorTexture,O.depthStencilTexture),e.setRenderTarget(E))}let W=D[g];W===void 0&&(W=new Wt,W.layers.enable(g),W.viewport=new st,D[g]=W),W.matrix.fromArray(H.transform.matrix),W.matrix.decompose(W.position,W.quaternion,W.scale),W.projectionMatrix.fromArray(H.projectionMatrix),W.projectionMatrixInverse.copy(W.projectionMatrix).invert(),W.viewport.set(j.x,j.y,j.width,j.height),g===0&&(k.matrix.copy(W.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),Le===!0&&k.cameras.push(W)}const we=r.enabledFeatures;if(we&&we.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&S){f=i.getBinding();const g=f.getDepthInformation(_e[0]);g&&g.isValid&&g.texture&&m.init(g,r.renderState)}if(we&&we.includes("camera-access")&&S){e.state.unbindTexture(),f=i.getBinding();for(let g=0;g<_e.length;g++){const H=_e[g].camera;if(H){let j=h[H];j||(j=new Hf,h[H]=j);const W=f.getCameraImage(H);j.sourceTexture=W}}}}for(let _e=0;_e<R.length;_e++){const Le=C[_e],we=R[_e];Le!==null&&we!==void 0&&we.update(Le,se,c||o)}Je&&Je(ee,se),se.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:se}),v=null}const Ye=new kf;Ye.setAnimationLoop(Qe),this.setAnimationLoop=function(ee){Je=ee},this.dispose=function(){}}}const di=new Sn,Bx=new pt;function zx(n,e){function t(m,h){m.matrixAutoUpdate===!0&&m.updateMatrix(),h.value.copy(m.matrix)}function i(m,h){h.color.getRGB(m.fogColor.value,Ff(n)),h.isFog?(m.fogNear.value=h.near,m.fogFar.value=h.far):h.isFogExp2&&(m.fogDensity.value=h.density)}function r(m,h,w,b,E){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(m,h):h.isMeshToonMaterial?(s(m,h),f(m,h)):h.isMeshPhongMaterial?(s(m,h),u(m,h)):h.isMeshStandardMaterial?(s(m,h),d(m,h),h.isMeshPhysicalMaterial&&p(m,h,E)):h.isMeshMatcapMaterial?(s(m,h),v(m,h)):h.isMeshDepthMaterial?s(m,h):h.isMeshDistanceMaterial?(s(m,h),S(m,h)):h.isMeshNormalMaterial?s(m,h):h.isLineBasicMaterial?(o(m,h),h.isLineDashedMaterial&&a(m,h)):h.isPointsMaterial?l(m,h,w,b):h.isSpriteMaterial?c(m,h):h.isShadowMaterial?(m.color.value.copy(h.color),m.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(m,h){m.opacity.value=h.opacity,h.color&&m.diffuse.value.copy(h.color),h.emissive&&m.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.bumpMap&&(m.bumpMap.value=h.bumpMap,t(h.bumpMap,m.bumpMapTransform),m.bumpScale.value=h.bumpScale,h.side===Bt&&(m.bumpScale.value*=-1)),h.normalMap&&(m.normalMap.value=h.normalMap,t(h.normalMap,m.normalMapTransform),m.normalScale.value.copy(h.normalScale),h.side===Bt&&m.normalScale.value.negate()),h.displacementMap&&(m.displacementMap.value=h.displacementMap,t(h.displacementMap,m.displacementMapTransform),m.displacementScale.value=h.displacementScale,m.displacementBias.value=h.displacementBias),h.emissiveMap&&(m.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,m.emissiveMapTransform)),h.specularMap&&(m.specularMap.value=h.specularMap,t(h.specularMap,m.specularMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest);const w=e.get(h),b=w.envMap,E=w.envMapRotation;b&&(m.envMap.value=b,di.copy(E),di.x*=-1,di.y*=-1,di.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(di.y*=-1,di.z*=-1),m.envMapRotation.value.setFromMatrix4(Bx.makeRotationFromEuler(di)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=h.reflectivity,m.ior.value=h.ior,m.refractionRatio.value=h.refractionRatio),h.lightMap&&(m.lightMap.value=h.lightMap,m.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,m.lightMapTransform)),h.aoMap&&(m.aoMap.value=h.aoMap,m.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,m.aoMapTransform))}function o(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform))}function a(m,h){m.dashSize.value=h.dashSize,m.totalSize.value=h.dashSize+h.gapSize,m.scale.value=h.scale}function l(m,h,w,b){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.size.value=h.size*w,m.scale.value=b*.5,h.map&&(m.map.value=h.map,t(h.map,m.uvTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function c(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.rotation.value=h.rotation,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function u(m,h){m.specular.value.copy(h.specular),m.shininess.value=Math.max(h.shininess,1e-4)}function f(m,h){h.gradientMap&&(m.gradientMap.value=h.gradientMap)}function d(m,h){m.metalness.value=h.metalness,h.metalnessMap&&(m.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,m.metalnessMapTransform)),m.roughness.value=h.roughness,h.roughnessMap&&(m.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,m.roughnessMapTransform)),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)}function p(m,h,w){m.ior.value=h.ior,h.sheen>0&&(m.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),m.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(m.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,m.sheenColorMapTransform)),h.sheenRoughnessMap&&(m.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,m.sheenRoughnessMapTransform))),h.clearcoat>0&&(m.clearcoat.value=h.clearcoat,m.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(m.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,m.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(m.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Bt&&m.clearcoatNormalScale.value.negate())),h.dispersion>0&&(m.dispersion.value=h.dispersion),h.iridescence>0&&(m.iridescence.value=h.iridescence,m.iridescenceIOR.value=h.iridescenceIOR,m.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(m.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,m.iridescenceMapTransform)),h.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),h.transmission>0&&(m.transmission.value=h.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),h.transmissionMap&&(m.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,m.transmissionMapTransform)),m.thickness.value=h.thickness,h.thicknessMap&&(m.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=h.attenuationDistance,m.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(m.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(m.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=h.specularIntensity,m.specularColor.value.copy(h.specularColor),h.specularColorMap&&(m.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,m.specularColorMapTransform)),h.specularIntensityMap&&(m.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,h){h.matcap&&(m.matcap.value=h.matcap)}function S(m,h){const w=e.get(h).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Hx(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(w,b){const E=b.program;i.uniformBlockBinding(w,E)}function c(w,b){let E=r[w.id];E===void 0&&(v(w),E=u(w),r[w.id]=E,w.addEventListener("dispose",m));const R=b.program;i.updateUBOMapping(w,R);const C=e.render.frame;s[w.id]!==C&&(d(w),s[w.id]=C)}function u(w){const b=f();w.__bindingPointIndex=b;const E=n.createBuffer(),R=w.__size,C=w.usage;return n.bindBuffer(n.UNIFORM_BUFFER,E),n.bufferData(n.UNIFORM_BUFFER,R,C),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,b,E),E}function f(){for(let w=0;w<a;w++)if(o.indexOf(w)===-1)return o.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(w){const b=r[w.id],E=w.uniforms,R=w.__cache;n.bindBuffer(n.UNIFORM_BUFFER,b);for(let C=0,L=E.length;C<L;C++){const F=Array.isArray(E[C])?E[C]:[E[C]];for(let T=0,y=F.length;T<y;T++){const D=F[T];if(p(D,C,T,R)===!0){const k=D.__offset,q=Array.isArray(D.value)?D.value:[D.value];let Z=0;for(let te=0;te<q.length;te++){const K=q[te],ne=S(K);typeof K=="number"||typeof K=="boolean"?(D.__data[0]=K,n.bufferSubData(n.UNIFORM_BUFFER,k+Z,D.__data)):K.isMatrix3?(D.__data[0]=K.elements[0],D.__data[1]=K.elements[1],D.__data[2]=K.elements[2],D.__data[3]=0,D.__data[4]=K.elements[3],D.__data[5]=K.elements[4],D.__data[6]=K.elements[5],D.__data[7]=0,D.__data[8]=K.elements[6],D.__data[9]=K.elements[7],D.__data[10]=K.elements[8],D.__data[11]=0):(K.toArray(D.__data,Z),Z+=ne.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,k,D.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(w,b,E,R){const C=w.value,L=b+"_"+E;if(R[L]===void 0)return typeof C=="number"||typeof C=="boolean"?R[L]=C:R[L]=C.clone(),!0;{const F=R[L];if(typeof C=="number"||typeof C=="boolean"){if(F!==C)return R[L]=C,!0}else if(F.equals(C)===!1)return F.copy(C),!0}return!1}function v(w){const b=w.uniforms;let E=0;const R=16;for(let L=0,F=b.length;L<F;L++){const T=Array.isArray(b[L])?b[L]:[b[L]];for(let y=0,D=T.length;y<D;y++){const k=T[y],q=Array.isArray(k.value)?k.value:[k.value];for(let Z=0,te=q.length;Z<te;Z++){const K=q[Z],ne=S(K),z=E%R,he=z%ne.boundary,pe=z+he;E+=he,pe!==0&&R-pe<ne.storage&&(E+=R-pe),k.__data=new Float32Array(ne.storage/Float32Array.BYTES_PER_ELEMENT),k.__offset=E,E+=ne.storage}}}const C=E%R;return C>0&&(E+=R-C),w.__size=E,w.__cache={},this}function S(w){const b={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(b.boundary=4,b.storage=4):w.isVector2?(b.boundary=8,b.storage=8):w.isVector3||w.isColor?(b.boundary=16,b.storage=12):w.isVector4?(b.boundary=16,b.storage=16):w.isMatrix3?(b.boundary=48,b.storage=48):w.isMatrix4?(b.boundary=64,b.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),b}function m(w){const b=w.target;b.removeEventListener("dispose",m);const E=o.indexOf(b.__bindingPointIndex);o.splice(E,1),n.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function h(){for(const w in r)n.deleteBuffer(r[w]);o=[],r={},s={}}return{bind:l,update:c,dispose:h}}class Vx{constructor(e={}){const{canvas:t=gm(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let p;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=i.getContextAttributes().alpha}else p=o;const v=new Uint32Array(4),S=new Int32Array(4);let m=null,h=null;const w=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Zn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const E=this;let R=!1;this._outputColorSpace=Kt;let C=0,L=0,F=null,T=-1,y=null;const D=new st,k=new st;let q=null;const Z=new je(0);let te=0,K=t.width,ne=t.height,z=1,he=null,pe=null;const ye=new st(0,0,K,ne),Ue=new st(0,0,K,ne);let Je=!1;const Qe=new Sl;let Ye=!1,ee=!1;const se=new pt,_e=new B,Le=new st,we={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let We=!1;function A(){return F===null?z:1}let g=i;function H(M,U){return t.getContext(M,U)}try{const M={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${fl}`),t.addEventListener("webglcontextlost",de,!1),t.addEventListener("webglcontextrestored",Re,!1),t.addEventListener("webglcontextcreationerror",ce,!1),g===null){const U="webgl2";if(g=H(U,M),g===null)throw H(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let j,W,O,oe,Y,Q,ie,xe,x,_,P,V,J,G,Se,ae,Ee,Te,le,ve,Ce,be,me,Be;function I(){j=new Zv(g),j.init(),be=new Ix(g,j),W=new Wv(g,j,e,be),O=new Dx(g,j),W.reversedDepthBuffer&&d&&O.buffers.depth.setReversed(!0),oe=new e0(g),Y=new vx,Q=new Lx(g,j,O,Y,W,be,oe),ie=new qv(E),xe=new jv(E),x=new og(g),me=new Gv(g,x),_=new Jv(g,x,oe,me),P=new n0(g,_,x,oe),le=new t0(g,W,Q),ae=new Xv(Y),V=new _x(E,ie,xe,j,W,me,ae),J=new zx(E,Y),G=new Mx,Se=new Ax(j),Te=new Vv(E,ie,xe,O,P,p,l),Ee=new Cx(E,P,W),Be=new Hx(g,oe,W,O),ve=new kv(g,j,oe),Ce=new Qv(g,j,oe),oe.programs=V.programs,E.capabilities=W,E.extensions=j,E.properties=Y,E.renderLists=G,E.shadowMap=Ee,E.state=O,E.info=oe}I();const fe=new Ox(E,g);this.xr=fe,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const M=j.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=j.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(M){M!==void 0&&(z=M,this.setSize(K,ne,!1))},this.getSize=function(M){return M.set(K,ne)},this.setSize=function(M,U,X=!0){if(fe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}K=M,ne=U,t.width=Math.floor(M*z),t.height=Math.floor(U*z),X===!0&&(t.style.width=M+"px",t.style.height=U+"px"),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(K*z,ne*z).floor()},this.setDrawingBufferSize=function(M,U,X){K=M,ne=U,z=X,t.width=Math.floor(M*X),t.height=Math.floor(U*X),this.setViewport(0,0,M,U)},this.getCurrentViewport=function(M){return M.copy(D)},this.getViewport=function(M){return M.copy(ye)},this.setViewport=function(M,U,X,$){M.isVector4?ye.set(M.x,M.y,M.z,M.w):ye.set(M,U,X,$),O.viewport(D.copy(ye).multiplyScalar(z).round())},this.getScissor=function(M){return M.copy(Ue)},this.setScissor=function(M,U,X,$){M.isVector4?Ue.set(M.x,M.y,M.z,M.w):Ue.set(M,U,X,$),O.scissor(k.copy(Ue).multiplyScalar(z).round())},this.getScissorTest=function(){return Je},this.setScissorTest=function(M){O.setScissorTest(Je=M)},this.setOpaqueSort=function(M){he=M},this.setTransparentSort=function(M){pe=M},this.getClearColor=function(M){return M.copy(Te.getClearColor())},this.setClearColor=function(){Te.setClearColor(...arguments)},this.getClearAlpha=function(){return Te.getClearAlpha()},this.setClearAlpha=function(){Te.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,X=!0){let $=0;if(M){let N=!1;if(F!==null){const ue=F.texture.format;N=ue===_l||ue===gl||ue===ml}if(N){const ue=F.texture.type,Me=ue===Mn||ue===yi||ue===Ir||ue===Ur||ue===dl||ue===pl,Pe=Te.getClearColor(),Ae=Te.getClearAlpha(),Fe=Pe.r,Oe=Pe.g,Ie=Pe.b;Me?(v[0]=Fe,v[1]=Oe,v[2]=Ie,v[3]=Ae,g.clearBufferuiv(g.COLOR,0,v)):(S[0]=Fe,S[1]=Oe,S[2]=Ie,S[3]=Ae,g.clearBufferiv(g.COLOR,0,S))}else $|=g.COLOR_BUFFER_BIT}U&&($|=g.DEPTH_BUFFER_BIT),X&&($|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",de,!1),t.removeEventListener("webglcontextrestored",Re,!1),t.removeEventListener("webglcontextcreationerror",ce,!1),Te.dispose(),G.dispose(),Se.dispose(),Y.dispose(),ie.dispose(),xe.dispose(),P.dispose(),me.dispose(),Be.dispose(),V.dispose(),fe.dispose(),fe.removeEventListener("sessionstart",ln),fe.removeEventListener("sessionend",bl),ii.stop()};function de(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),R=!0}function Re(){console.log("THREE.WebGLRenderer: Context Restored."),R=!1;const M=oe.autoReset,U=Ee.enabled,X=Ee.autoUpdate,$=Ee.needsUpdate,N=Ee.type;I(),oe.autoReset=M,Ee.enabled=U,Ee.autoUpdate=X,Ee.needsUpdate=$,Ee.type=N}function ce(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function re(M){const U=M.target;U.removeEventListener("dispose",re),De(U)}function De(M){ze(M),Y.remove(M)}function ze(M){const U=Y.get(M).programs;U!==void 0&&(U.forEach(function(X){V.releaseProgram(X)}),M.isShaderMaterial&&V.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,X,$,N,ue){U===null&&(U=we);const Me=N.isMesh&&N.matrixWorld.determinant()<0,Pe=Kf(M,U,X,$,N);O.setMaterial($,Me);let Ae=X.index,Fe=1;if($.wireframe===!0){if(Ae=_.getWireframeAttribute(X),Ae===void 0)return;Fe=2}const Oe=X.drawRange,Ie=X.attributes.position;let qe=Oe.start*Fe,it=(Oe.start+Oe.count)*Fe;ue!==null&&(qe=Math.max(qe,ue.start*Fe),it=Math.min(it,(ue.start+ue.count)*Fe)),Ae!==null?(qe=Math.max(qe,0),it=Math.min(it,Ae.count)):Ie!=null&&(qe=Math.max(qe,0),it=Math.min(it,Ie.count));const dt=it-qe;if(dt<0||dt===1/0)return;me.setup(N,$,Pe,X,Ae);let ut,ot=ve;if(Ae!==null&&(ut=x.get(Ae),ot=Ce,ot.setIndex(ut)),N.isMesh)$.wireframe===!0?(O.setLineWidth($.wireframeLinewidth*A()),ot.setMode(g.LINES)):ot.setMode(g.TRIANGLES);else if(N.isLine){let Ne=$.linewidth;Ne===void 0&&(Ne=1),O.setLineWidth(Ne*A()),N.isLineSegments?ot.setMode(g.LINES):N.isLineLoop?ot.setMode(g.LINE_LOOP):ot.setMode(g.LINE_STRIP)}else N.isPoints?ot.setMode(g.POINTS):N.isSprite&&ot.setMode(g.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Br("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ot.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(j.get("WEBGL_multi_draw"))ot.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const Ne=N._multiDrawStarts,ft=N._multiDrawCounts,$e=N._multiDrawCount,zt=Ae?x.get(Ae).bytesPerElement:1,wi=Y.get($).currentProgram.getUniforms();for(let Ht=0;Ht<$e;Ht++)wi.setValue(g,"_gl_DrawID",Ht),ot.render(Ne[Ht]/zt,ft[Ht])}else if(N.isInstancedMesh)ot.renderInstances(qe,dt,N.count);else if(X.isInstancedBufferGeometry){const Ne=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,ft=Math.min(X.instanceCount,Ne);ot.renderInstances(qe,dt,ft)}else ot.render(qe,dt)};function lt(M,U,X){M.transparent===!0&&M.side===jt&&M.forceSinglePass===!1?(M.side=Bt,M.needsUpdate=!0,$r(M,U,X),M.side=Qn,M.needsUpdate=!0,$r(M,U,X),M.side=jt):$r(M,U,X)}this.compile=function(M,U,X=null){X===null&&(X=M),h=Se.get(X),h.init(U),b.push(h),X.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(h.pushLight(N),N.castShadow&&h.pushShadow(N))}),M!==X&&M.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(h.pushLight(N),N.castShadow&&h.pushShadow(N))}),h.setupLights();const $=new Set;return M.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const ue=N.material;if(ue)if(Array.isArray(ue))for(let Me=0;Me<ue.length;Me++){const Pe=ue[Me];lt(Pe,X,N),$.add(Pe)}else lt(ue,X,N),$.add(ue)}),h=b.pop(),$},this.compileAsync=function(M,U,X=null){const $=this.compile(M,U,X);return new Promise(N=>{function ue(){if($.forEach(function(Me){Y.get(Me).currentProgram.isReady()&&$.delete(Me)}),$.size===0){N(M);return}setTimeout(ue,10)}j.get("KHR_parallel_shader_compile")!==null?ue():setTimeout(ue,10)})};let et=null;function En(M){et&&et(M)}function ln(){ii.stop()}function bl(){ii.start()}const ii=new kf;ii.setAnimationLoop(En),typeof self<"u"&&ii.setContext(self),this.setAnimationLoop=function(M){et=M,fe.setAnimationLoop(M),M===null?ii.stop():ii.start()},fe.addEventListener("sessionstart",ln),fe.addEventListener("sessionend",bl),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),fe.enabled===!0&&fe.isPresenting===!0&&(fe.cameraAutoUpdate===!0&&fe.updateCamera(U),U=fe.getCamera()),M.isScene===!0&&M.onBeforeRender(E,M,U,F),h=Se.get(M,b.length),h.init(U),b.push(h),se.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Qe.setFromProjectionMatrix(se,mn,U.reversedDepth),ee=this.localClippingEnabled,Ye=ae.init(this.clippingPlanes,ee),m=G.get(M,w.length),m.init(),w.push(m),fe.enabled===!0&&fe.isPresenting===!0){const ue=E.xr.getDepthSensingMesh();ue!==null&&js(ue,U,-1/0,E.sortObjects)}js(M,U,0,E.sortObjects),m.finish(),E.sortObjects===!0&&m.sort(he,pe),We=fe.enabled===!1||fe.isPresenting===!1||fe.hasDepthSensing()===!1,We&&Te.addToRenderList(m,M),this.info.render.frame++,Ye===!0&&ae.beginShadows();const X=h.state.shadowsArray;Ee.render(X,M,U),Ye===!0&&ae.endShadows(),this.info.autoReset===!0&&this.info.reset();const $=m.opaque,N=m.transmissive;if(h.setupLights(),U.isArrayCamera){const ue=U.cameras;if(N.length>0)for(let Me=0,Pe=ue.length;Me<Pe;Me++){const Ae=ue[Me];wl($,N,M,Ae)}We&&Te.render(M);for(let Me=0,Pe=ue.length;Me<Pe;Me++){const Ae=ue[Me];Al(m,M,Ae,Ae.viewport)}}else N.length>0&&wl($,N,M,U),We&&Te.render(M),Al(m,M,U);F!==null&&L===0&&(Q.updateMultisampleRenderTarget(F),Q.updateRenderTargetMipmap(F)),M.isScene===!0&&M.onAfterRender(E,M,U),me.resetDefaultState(),T=-1,y=null,b.pop(),b.length>0?(h=b[b.length-1],Ye===!0&&ae.setGlobalState(E.clippingPlanes,h.state.camera)):h=null,w.pop(),w.length>0?m=w[w.length-1]:m=null};function js(M,U,X,$){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)X=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)h.pushLight(M),M.castShadow&&h.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||Qe.intersectsSprite(M)){$&&Le.setFromMatrixPosition(M.matrixWorld).applyMatrix4(se);const Me=P.update(M),Pe=M.material;Pe.visible&&m.push(M,Me,Pe,X,Le.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||Qe.intersectsObject(M))){const Me=P.update(M),Pe=M.material;if($&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Le.copy(M.boundingSphere.center)):(Me.boundingSphere===null&&Me.computeBoundingSphere(),Le.copy(Me.boundingSphere.center)),Le.applyMatrix4(M.matrixWorld).applyMatrix4(se)),Array.isArray(Pe)){const Ae=Me.groups;for(let Fe=0,Oe=Ae.length;Fe<Oe;Fe++){const Ie=Ae[Fe],qe=Pe[Ie.materialIndex];qe&&qe.visible&&m.push(M,Me,qe,X,Le.z,Ie)}}else Pe.visible&&m.push(M,Me,Pe,X,Le.z,null)}}const ue=M.children;for(let Me=0,Pe=ue.length;Me<Pe;Me++)js(ue[Me],U,X,$)}function Al(M,U,X,$){const N=M.opaque,ue=M.transmissive,Me=M.transparent;h.setupLightsView(X),Ye===!0&&ae.setGlobalState(E.clippingPlanes,X),$&&O.viewport(D.copy($)),N.length>0&&Yr(N,U,X),ue.length>0&&Yr(ue,U,X),Me.length>0&&Yr(Me,U,X),O.buffers.depth.setTest(!0),O.buffers.depth.setMask(!0),O.buffers.color.setMask(!0),O.setPolygonOffset(!1)}function wl(M,U,X,$){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[$.id]===void 0&&(h.state.transmissionRenderTarget[$.id]=new Ti(1,1,{generateMipmaps:!0,type:j.has("EXT_color_buffer_half_float")||j.has("EXT_color_buffer_float")?Vr:Mn,minFilter:Mi,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ke.workingColorSpace}));const ue=h.state.transmissionRenderTarget[$.id],Me=$.viewport||D;ue.setSize(Me.z*E.transmissionResolutionScale,Me.w*E.transmissionResolutionScale);const Pe=E.getRenderTarget(),Ae=E.getActiveCubeFace(),Fe=E.getActiveMipmapLevel();E.setRenderTarget(ue),E.getClearColor(Z),te=E.getClearAlpha(),te<1&&E.setClearColor(16777215,.5),E.clear(),We&&Te.render(X);const Oe=E.toneMapping;E.toneMapping=Zn;const Ie=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),h.setupLightsView($),Ye===!0&&ae.setGlobalState(E.clippingPlanes,$),Yr(M,X,$),Q.updateMultisampleRenderTarget(ue),Q.updateRenderTargetMipmap(ue),j.has("WEBGL_multisampled_render_to_texture")===!1){let qe=!1;for(let it=0,dt=U.length;it<dt;it++){const ut=U[it],ot=ut.object,Ne=ut.geometry,ft=ut.material,$e=ut.group;if(ft.side===jt&&ot.layers.test($.layers)){const zt=ft.side;ft.side=Bt,ft.needsUpdate=!0,Rl(ot,X,$,Ne,ft,$e),ft.side=zt,ft.needsUpdate=!0,qe=!0}}qe===!0&&(Q.updateMultisampleRenderTarget(ue),Q.updateRenderTargetMipmap(ue))}E.setRenderTarget(Pe,Ae,Fe),E.setClearColor(Z,te),Ie!==void 0&&($.viewport=Ie),E.toneMapping=Oe}function Yr(M,U,X){const $=U.isScene===!0?U.overrideMaterial:null;for(let N=0,ue=M.length;N<ue;N++){const Me=M[N],Pe=Me.object,Ae=Me.geometry,Fe=Me.group;let Oe=Me.material;Oe.allowOverride===!0&&$!==null&&(Oe=$),Pe.layers.test(X.layers)&&Rl(Pe,U,X,Ae,Oe,Fe)}}function Rl(M,U,X,$,N,ue){M.onBeforeRender(E,U,X,$,N,ue),M.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),N.onBeforeRender(E,U,X,$,M,ue),N.transparent===!0&&N.side===jt&&N.forceSinglePass===!1?(N.side=Bt,N.needsUpdate=!0,E.renderBufferDirect(X,U,$,N,M,ue),N.side=Qn,N.needsUpdate=!0,E.renderBufferDirect(X,U,$,N,M,ue),N.side=jt):E.renderBufferDirect(X,U,$,N,M,ue),M.onAfterRender(E,U,X,$,N,ue)}function $r(M,U,X){U.isScene!==!0&&(U=we);const $=Y.get(M),N=h.state.lights,ue=h.state.shadowsArray,Me=N.state.version,Pe=V.getParameters(M,N.state,ue,U,X),Ae=V.getProgramCacheKey(Pe);let Fe=$.programs;$.environment=M.isMeshStandardMaterial?U.environment:null,$.fog=U.fog,$.envMap=(M.isMeshStandardMaterial?xe:ie).get(M.envMap||$.environment),$.envMapRotation=$.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Fe===void 0&&(M.addEventListener("dispose",re),Fe=new Map,$.programs=Fe);let Oe=Fe.get(Ae);if(Oe!==void 0){if($.currentProgram===Oe&&$.lightsStateVersion===Me)return Pl(M,Pe),Oe}else Pe.uniforms=V.getUniforms(M),M.onBeforeCompile(Pe,E),Oe=V.acquireProgram(Pe,Ae),Fe.set(Ae,Oe),$.uniforms=Pe.uniforms;const Ie=$.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Ie.clippingPlanes=ae.uniform),Pl(M,Pe),$.needsLights=Zf(M),$.lightsStateVersion=Me,$.needsLights&&(Ie.ambientLightColor.value=N.state.ambient,Ie.lightProbe.value=N.state.probe,Ie.directionalLights.value=N.state.directional,Ie.directionalLightShadows.value=N.state.directionalShadow,Ie.spotLights.value=N.state.spot,Ie.spotLightShadows.value=N.state.spotShadow,Ie.rectAreaLights.value=N.state.rectArea,Ie.ltc_1.value=N.state.rectAreaLTC1,Ie.ltc_2.value=N.state.rectAreaLTC2,Ie.pointLights.value=N.state.point,Ie.pointLightShadows.value=N.state.pointShadow,Ie.hemisphereLights.value=N.state.hemi,Ie.directionalShadowMap.value=N.state.directionalShadowMap,Ie.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Ie.spotShadowMap.value=N.state.spotShadowMap,Ie.spotLightMatrix.value=N.state.spotLightMatrix,Ie.spotLightMap.value=N.state.spotLightMap,Ie.pointShadowMap.value=N.state.pointShadowMap,Ie.pointShadowMatrix.value=N.state.pointShadowMatrix),$.currentProgram=Oe,$.uniformsList=null,Oe}function Cl(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=Cs.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function Pl(M,U){const X=Y.get(M);X.outputColorSpace=U.outputColorSpace,X.batching=U.batching,X.batchingColor=U.batchingColor,X.instancing=U.instancing,X.instancingColor=U.instancingColor,X.instancingMorph=U.instancingMorph,X.skinning=U.skinning,X.morphTargets=U.morphTargets,X.morphNormals=U.morphNormals,X.morphColors=U.morphColors,X.morphTargetsCount=U.morphTargetsCount,X.numClippingPlanes=U.numClippingPlanes,X.numIntersection=U.numClipIntersection,X.vertexAlphas=U.vertexAlphas,X.vertexTangents=U.vertexTangents,X.toneMapping=U.toneMapping}function Kf(M,U,X,$,N){U.isScene!==!0&&(U=we),Q.resetTextureUnits();const ue=U.fog,Me=$.isMeshStandardMaterial?U.environment:null,Pe=F===null?E.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:sr,Ae=($.isMeshStandardMaterial?xe:ie).get($.envMap||Me),Fe=$.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,Oe=!!X.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),Ie=!!X.morphAttributes.position,qe=!!X.morphAttributes.normal,it=!!X.morphAttributes.color;let dt=Zn;$.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(dt=E.toneMapping);const ut=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,ot=ut!==void 0?ut.length:0,Ne=Y.get($),ft=h.state.lights;if(Ye===!0&&(ee===!0||M!==y)){const wt=M===y&&$.id===T;ae.setState($,M,wt)}let $e=!1;$.version===Ne.__version?(Ne.needsLights&&Ne.lightsStateVersion!==ft.state.version||Ne.outputColorSpace!==Pe||N.isBatchedMesh&&Ne.batching===!1||!N.isBatchedMesh&&Ne.batching===!0||N.isBatchedMesh&&Ne.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&Ne.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&Ne.instancing===!1||!N.isInstancedMesh&&Ne.instancing===!0||N.isSkinnedMesh&&Ne.skinning===!1||!N.isSkinnedMesh&&Ne.skinning===!0||N.isInstancedMesh&&Ne.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Ne.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&Ne.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&Ne.instancingMorph===!1&&N.morphTexture!==null||Ne.envMap!==Ae||$.fog===!0&&Ne.fog!==ue||Ne.numClippingPlanes!==void 0&&(Ne.numClippingPlanes!==ae.numPlanes||Ne.numIntersection!==ae.numIntersection)||Ne.vertexAlphas!==Fe||Ne.vertexTangents!==Oe||Ne.morphTargets!==Ie||Ne.morphNormals!==qe||Ne.morphColors!==it||Ne.toneMapping!==dt||Ne.morphTargetsCount!==ot)&&($e=!0):($e=!0,Ne.__version=$.version);let zt=Ne.currentProgram;$e===!0&&(zt=$r($,U,N));let wi=!1,Ht=!1,lr=!1;const ht=zt.getUniforms(),qt=Ne.uniforms;if(O.useProgram(zt.program)&&(wi=!0,Ht=!0,lr=!0),$.id!==T&&(T=$.id,Ht=!0),wi||y!==M){O.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),ht.setValue(g,"projectionMatrix",M.projectionMatrix),ht.setValue(g,"viewMatrix",M.matrixWorldInverse);const Nt=ht.map.cameraPosition;Nt!==void 0&&Nt.setValue(g,_e.setFromMatrixPosition(M.matrixWorld)),W.logarithmicDepthBuffer&&ht.setValue(g,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&ht.setValue(g,"isOrthographic",M.isOrthographicCamera===!0),y!==M&&(y=M,Ht=!0,lr=!0)}if(N.isSkinnedMesh){ht.setOptional(g,N,"bindMatrix"),ht.setOptional(g,N,"bindMatrixInverse");const wt=N.skeleton;wt&&(wt.boneTexture===null&&wt.computeBoneTexture(),ht.setValue(g,"boneTexture",wt.boneTexture,Q))}N.isBatchedMesh&&(ht.setOptional(g,N,"batchingTexture"),ht.setValue(g,"batchingTexture",N._matricesTexture,Q),ht.setOptional(g,N,"batchingIdTexture"),ht.setValue(g,"batchingIdTexture",N._indirectTexture,Q),ht.setOptional(g,N,"batchingColorTexture"),N._colorsTexture!==null&&ht.setValue(g,"batchingColorTexture",N._colorsTexture,Q));const Yt=X.morphAttributes;if((Yt.position!==void 0||Yt.normal!==void 0||Yt.color!==void 0)&&le.update(N,X,zt),(Ht||Ne.receiveShadow!==N.receiveShadow)&&(Ne.receiveShadow=N.receiveShadow,ht.setValue(g,"receiveShadow",N.receiveShadow)),$.isMeshGouraudMaterial&&$.envMap!==null&&(qt.envMap.value=Ae,qt.flipEnvMap.value=Ae.isCubeTexture&&Ae.isRenderTargetTexture===!1?-1:1),$.isMeshStandardMaterial&&$.envMap===null&&U.environment!==null&&(qt.envMapIntensity.value=U.environmentIntensity),Ht&&(ht.setValue(g,"toneMappingExposure",E.toneMappingExposure),Ne.needsLights&&jf(qt,lr),ue&&$.fog===!0&&J.refreshFogUniforms(qt,ue),J.refreshMaterialUniforms(qt,$,z,ne,h.state.transmissionRenderTarget[M.id]),Cs.upload(g,Cl(Ne),qt,Q)),$.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(Cs.upload(g,Cl(Ne),qt,Q),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&ht.setValue(g,"center",N.center),ht.setValue(g,"modelViewMatrix",N.modelViewMatrix),ht.setValue(g,"normalMatrix",N.normalMatrix),ht.setValue(g,"modelMatrix",N.matrixWorld),$.isShaderMaterial||$.isRawShaderMaterial){const wt=$.uniformsGroups;for(let Nt=0,Zs=wt.length;Nt<Zs;Nt++){const ri=wt[Nt];Be.update(ri,zt),Be.bind(ri,zt)}}return zt}function jf(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function Zf(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return L},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(M,U,X){const $=Y.get(M);$.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,$.__autoAllocateDepthBuffer===!1&&($.__useRenderToTexture=!1),Y.get(M.texture).__webglTexture=U,Y.get(M.depthTexture).__webglTexture=$.__autoAllocateDepthBuffer?void 0:X,$.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const X=Y.get(M);X.__webglFramebuffer=U,X.__useDefaultFramebuffer=U===void 0};const Jf=g.createFramebuffer();this.setRenderTarget=function(M,U=0,X=0){F=M,C=U,L=X;let $=!0,N=null,ue=!1,Me=!1;if(M){const Ae=Y.get(M);if(Ae.__useDefaultFramebuffer!==void 0)O.bindFramebuffer(g.FRAMEBUFFER,null),$=!1;else if(Ae.__webglFramebuffer===void 0)Q.setupRenderTarget(M);else if(Ae.__hasExternalTextures)Q.rebindTextures(M,Y.get(M.texture).__webglTexture,Y.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Ie=M.depthTexture;if(Ae.__boundDepthTexture!==Ie){if(Ie!==null&&Y.has(Ie)&&(M.width!==Ie.image.width||M.height!==Ie.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Q.setupDepthRenderbuffer(M)}}const Fe=M.texture;(Fe.isData3DTexture||Fe.isDataArrayTexture||Fe.isCompressedArrayTexture)&&(Me=!0);const Oe=Y.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Oe[U])?N=Oe[U][X]:N=Oe[U],ue=!0):M.samples>0&&Q.useMultisampledRTT(M)===!1?N=Y.get(M).__webglMultisampledFramebuffer:Array.isArray(Oe)?N=Oe[X]:N=Oe,D.copy(M.viewport),k.copy(M.scissor),q=M.scissorTest}else D.copy(ye).multiplyScalar(z).floor(),k.copy(Ue).multiplyScalar(z).floor(),q=Je;if(X!==0&&(N=Jf),O.bindFramebuffer(g.FRAMEBUFFER,N)&&$&&O.drawBuffers(M,N),O.viewport(D),O.scissor(k),O.setScissorTest(q),ue){const Ae=Y.get(M.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+U,Ae.__webglTexture,X)}else if(Me){const Ae=U;for(let Fe=0;Fe<M.textures.length;Fe++){const Oe=Y.get(M.textures[Fe]);g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0+Fe,Oe.__webglTexture,X,Ae)}}else if(M!==null&&X!==0){const Ae=Y.get(M.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_2D,Ae.__webglTexture,X)}T=-1},this.readRenderTargetPixels=function(M,U,X,$,N,ue,Me,Pe=0){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ae=Y.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Me!==void 0&&(Ae=Ae[Me]),Ae){O.bindFramebuffer(g.FRAMEBUFFER,Ae);try{const Fe=M.textures[Pe],Oe=Fe.format,Ie=Fe.type;if(!W.textureFormatReadable(Oe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!W.textureTypeReadable(Ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-$&&X>=0&&X<=M.height-N&&(M.textures.length>1&&g.readBuffer(g.COLOR_ATTACHMENT0+Pe),g.readPixels(U,X,$,N,be.convert(Oe),be.convert(Ie),ue))}finally{const Fe=F!==null?Y.get(F).__webglFramebuffer:null;O.bindFramebuffer(g.FRAMEBUFFER,Fe)}}},this.readRenderTargetPixelsAsync=async function(M,U,X,$,N,ue,Me,Pe=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ae=Y.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Me!==void 0&&(Ae=Ae[Me]),Ae)if(U>=0&&U<=M.width-$&&X>=0&&X<=M.height-N){O.bindFramebuffer(g.FRAMEBUFFER,Ae);const Fe=M.textures[Pe],Oe=Fe.format,Ie=Fe.type;if(!W.textureFormatReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!W.textureTypeReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const qe=g.createBuffer();g.bindBuffer(g.PIXEL_PACK_BUFFER,qe),g.bufferData(g.PIXEL_PACK_BUFFER,ue.byteLength,g.STREAM_READ),M.textures.length>1&&g.readBuffer(g.COLOR_ATTACHMENT0+Pe),g.readPixels(U,X,$,N,be.convert(Oe),be.convert(Ie),0);const it=F!==null?Y.get(F).__webglFramebuffer:null;O.bindFramebuffer(g.FRAMEBUFFER,it);const dt=g.fenceSync(g.SYNC_GPU_COMMANDS_COMPLETE,0);return g.flush(),await _m(g,dt,4),g.bindBuffer(g.PIXEL_PACK_BUFFER,qe),g.getBufferSubData(g.PIXEL_PACK_BUFFER,0,ue),g.deleteBuffer(qe),g.deleteSync(dt),ue}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,U=null,X=0){const $=Math.pow(2,-X),N=Math.floor(M.image.width*$),ue=Math.floor(M.image.height*$),Me=U!==null?U.x:0,Pe=U!==null?U.y:0;Q.setTexture2D(M,0),g.copyTexSubImage2D(g.TEXTURE_2D,X,0,0,Me,Pe,N,ue),O.unbindTexture()};const Qf=g.createFramebuffer(),eh=g.createFramebuffer();this.copyTextureToTexture=function(M,U,X=null,$=null,N=0,ue=null){ue===null&&(N!==0?(Br("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ue=N,N=0):ue=0);let Me,Pe,Ae,Fe,Oe,Ie,qe,it,dt;const ut=M.isCompressedTexture?M.mipmaps[ue]:M.image;if(X!==null)Me=X.max.x-X.min.x,Pe=X.max.y-X.min.y,Ae=X.isBox3?X.max.z-X.min.z:1,Fe=X.min.x,Oe=X.min.y,Ie=X.isBox3?X.min.z:0;else{const Yt=Math.pow(2,-N);Me=Math.floor(ut.width*Yt),Pe=Math.floor(ut.height*Yt),M.isDataArrayTexture?Ae=ut.depth:M.isData3DTexture?Ae=Math.floor(ut.depth*Yt):Ae=1,Fe=0,Oe=0,Ie=0}$!==null?(qe=$.x,it=$.y,dt=$.z):(qe=0,it=0,dt=0);const ot=be.convert(U.format),Ne=be.convert(U.type);let ft;U.isData3DTexture?(Q.setTexture3D(U,0),ft=g.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(Q.setTexture2DArray(U,0),ft=g.TEXTURE_2D_ARRAY):(Q.setTexture2D(U,0),ft=g.TEXTURE_2D),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,U.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,U.unpackAlignment);const $e=g.getParameter(g.UNPACK_ROW_LENGTH),zt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),wi=g.getParameter(g.UNPACK_SKIP_PIXELS),Ht=g.getParameter(g.UNPACK_SKIP_ROWS),lr=g.getParameter(g.UNPACK_SKIP_IMAGES);g.pixelStorei(g.UNPACK_ROW_LENGTH,ut.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,ut.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Fe),g.pixelStorei(g.UNPACK_SKIP_ROWS,Oe),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Ie);const ht=M.isDataArrayTexture||M.isData3DTexture,qt=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const Yt=Y.get(M),wt=Y.get(U),Nt=Y.get(Yt.__renderTarget),Zs=Y.get(wt.__renderTarget);O.bindFramebuffer(g.READ_FRAMEBUFFER,Nt.__webglFramebuffer),O.bindFramebuffer(g.DRAW_FRAMEBUFFER,Zs.__webglFramebuffer);for(let ri=0;ri<Ae;ri++)ht&&(g.framebufferTextureLayer(g.READ_FRAMEBUFFER,g.COLOR_ATTACHMENT0,Y.get(M).__webglTexture,N,Ie+ri),g.framebufferTextureLayer(g.DRAW_FRAMEBUFFER,g.COLOR_ATTACHMENT0,Y.get(U).__webglTexture,ue,dt+ri)),g.blitFramebuffer(Fe,Oe,Me,Pe,qe,it,Me,Pe,g.DEPTH_BUFFER_BIT,g.NEAREST);O.bindFramebuffer(g.READ_FRAMEBUFFER,null),O.bindFramebuffer(g.DRAW_FRAMEBUFFER,null)}else if(N!==0||M.isRenderTargetTexture||Y.has(M)){const Yt=Y.get(M),wt=Y.get(U);O.bindFramebuffer(g.READ_FRAMEBUFFER,Qf),O.bindFramebuffer(g.DRAW_FRAMEBUFFER,eh);for(let Nt=0;Nt<Ae;Nt++)ht?g.framebufferTextureLayer(g.READ_FRAMEBUFFER,g.COLOR_ATTACHMENT0,Yt.__webglTexture,N,Ie+Nt):g.framebufferTexture2D(g.READ_FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_2D,Yt.__webglTexture,N),qt?g.framebufferTextureLayer(g.DRAW_FRAMEBUFFER,g.COLOR_ATTACHMENT0,wt.__webglTexture,ue,dt+Nt):g.framebufferTexture2D(g.DRAW_FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_2D,wt.__webglTexture,ue),N!==0?g.blitFramebuffer(Fe,Oe,Me,Pe,qe,it,Me,Pe,g.COLOR_BUFFER_BIT,g.NEAREST):qt?g.copyTexSubImage3D(ft,ue,qe,it,dt+Nt,Fe,Oe,Me,Pe):g.copyTexSubImage2D(ft,ue,qe,it,Fe,Oe,Me,Pe);O.bindFramebuffer(g.READ_FRAMEBUFFER,null),O.bindFramebuffer(g.DRAW_FRAMEBUFFER,null)}else qt?M.isDataTexture||M.isData3DTexture?g.texSubImage3D(ft,ue,qe,it,dt,Me,Pe,Ae,ot,Ne,ut.data):U.isCompressedArrayTexture?g.compressedTexSubImage3D(ft,ue,qe,it,dt,Me,Pe,Ae,ot,ut.data):g.texSubImage3D(ft,ue,qe,it,dt,Me,Pe,Ae,ot,Ne,ut):M.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,ue,qe,it,Me,Pe,ot,Ne,ut.data):M.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,ue,qe,it,ut.width,ut.height,ot,ut.data):g.texSubImage2D(g.TEXTURE_2D,ue,qe,it,Me,Pe,ot,Ne,ut);g.pixelStorei(g.UNPACK_ROW_LENGTH,$e),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,zt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,wi),g.pixelStorei(g.UNPACK_SKIP_ROWS,Ht),g.pixelStorei(g.UNPACK_SKIP_IMAGES,lr),ue===0&&U.generateMipmaps&&g.generateMipmap(ft),O.unbindTexture()},this.initRenderTarget=function(M){Y.get(M).__webglFramebuffer===void 0&&Q.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?Q.setTextureCube(M,0):M.isData3DTexture?Q.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?Q.setTexture2DArray(M,0):Q.setTexture2D(M,0),O.unbindTexture()},this.resetState=function(){C=0,L=0,F=null,O.reset(),me.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return mn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ke._getUnpackColorSpace()}}const Gx="/threejsdoorscene/assets/wood-COVWB8UA.jpg",kx="/threejsdoorscene/assets/wood_reflective-C4SChNaN.jpg",Wx="/threejsdoorscene/assets/wallpaper-DLSWu9V4.jpeg",Xx=zu({setup(){const n=si(null),e=si(1),t=si(2),i=si(6),r=si(3),s=si(6),o=si(!1),a=new Jm,l=a.load(Gx),c=a.load(kx),u=a.load(Wx);let f,d,p,v,S=null,m=null,h=0,w=0,b,E,R;function C(y,D){const k=new tn(y,D,.1),q=new Gi({map:l,roughness:.9}),Z=new Lt(k,q);return Z.castShadow=!0,Z.receiveShadow=!0,Z}function L(){if(!f||!S)return;m&&(S.remove(m),m.geometry.dispose()),m=C(e.value,t.value),m.position.x=e.value/2,m.position.y=t.value/2,m.position.z=0,S.position.set(-e.value/2,0,s.value/2),S.add(m);const y=(i.value-e.value)/2,D=(i.value-e.value)/2;b.geometry.dispose(),b.geometry=new tn(e.value,1-(t.value-2),.1),b.position.set(0,t.value+(1-(t.value-2))/2,s.value/2),E.geometry.dispose(),E.geometry=new tn(y,r.value,.1),E.position.set(-(e.value/2+y/2),r.value/2,s.value/2),R.geometry.dispose(),R.geometry=new tn(D,r.value,.1),R.position.set(e.value/2+D/2,r.value/2,s.value/2)}function F(){!f||!S||L()}function T(){o.value=!o.value}return ku(async()=>{if(!n.value)return;f=new km,f.background=new je(12571109);const y=n.value.clientWidth,D=n.value.clientHeight;d=new Wt(60,y/D,.1,1e3),d.position.set(5,3,7),p=new Vx({antialias:!0}),p.setSize(y,D),p.setPixelRatio(window.devicePixelRatio??1),p.shadowMap.enabled=!0,n.value.appendChild(p.domElement);const k=i.value,q=r.value,Z=s.value,te=new Lt(new qr(k,Z),new Gi({map:c,roughness:.1,side:jt}));te.rotation.x=-Math.PI/2,te.receiveShadow=!0,f.add(te);function K(_e,Le,we,We){const A=[];for(let H=0;H<6;H++)H===We?A.push(new Gi({map:u,side:jt,roughness:.4})):A.push(new Gi({color:16777215,side:jt,roughness:.8}));const g=new Lt(new tn(_e,Le,we),A);return g.receiveShadow=!0,g}const ne=K(k,q,.1,4);ne.position.set(0,q/2,-Z/2),f.add(ne);const z=K(.1,q,Z,0);z.position.set(-k/2,q/2,0),f.add(z);const he=K(.1,q,Z,1);he.position.set(k/2,q/2,0),f.add(he),E=K((k-e.value)/2,q,.1,5),E.position.set(-(e.value/2+(k-e.value)/4),q/2,Z/2),f.add(E),R=K((k-e.value)/2,q,.1,5),R.position.set(e.value/2+(k-e.value)/4,q/2,Z/2),f.add(R),b=K(e.value,q-t.value,.1,5),b.position.set(0,5,0),f.add(b);const pe=new Lt(new tn(1,1,1),new Gi({color:43520}));pe.position.set(-2,1.5,1),pe.castShadow=!0,pe.receiveShadow=!0,f.add(pe);const ye=new Lt(new Bs(.5,32,32),new Gi({color:255,metalness:.6,roughness:.2}));ye.position.set(2,.5,1),ye.castShadow=!0,ye.receiveShadow=!0,f.add(ye);const Ue=new ng(16777215,.1);Ue.position.set(5,10,7),Ue.castShadow=!1,f.add(Ue);const Je=new ig(16777215,.1);f.add(Je);const Qe=new eg(16760576,5,15);Qe.position.set(0,r.value-.15,0),Qe.castShadow=!0,f.add(Qe);const Ye=new Lt(new Bs(.1,16,16),new Ml({color:16760576}));Ye.position.copy(Qe.position),f.add(Ye),S=new vr,f.add(S),L();const{OrbitControls:ee}=await wp(async()=>{const{OrbitControls:_e}=await import("./OrbitControls-DAi2FuW_.js");return{OrbitControls:_e}},[]);v=new ee(d,p.domElement),v.enableDamping=!0,v.dampingFactor=.08,v.target.set(0,1,0),v.update();const se=()=>{pe.rotation.x+=.01,pe.rotation.y+=.01,ye.rotation.y-=.01;const _e=o.value?Math.PI/2:0;w+=(_e-w)*.05,S&&(S.rotation.y=w),v.update(),p.render(f,d),h=requestAnimationFrame(se)};se(),window.addEventListener("resize",()=>{const _e=n.value.clientWidth,Le=n.value.clientHeight;d.aspect=_e/Le,d.updateProjectionMatrix(),p.setSize(_e,Le)})}),Wu(()=>{cancelAnimationFrame(h),p&&n.value&&(p.dispose(),n.value.removeChild(p.domElement))}),{canvasContainer:n,doorWidth:e,doorHeight:t,updateDoorSafe:F,isOpen:o,toggleDoor:T}}}),$f=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},qx={class:"three-container"},Yx={ref:"canvasContainer",class:"canvas"},$x={class:"ui"};function Kx(n,e,t,i,r,s){return uf(),Od("div",qx,[fn("div",Yx,null,512),fn("div",$x,[e[5]||(e[5]=fn("h3",null,"Дверь",-1)),fn("label",null,"Ширина: "+Ms(n.doorWidth.toFixed(2))+" м",1),Nl(fn("input",{type:"range",min:"0.5",max:"2.0",step:"0.01","onUpdate:modelValue":e[0]||(e[0]=o=>n.doorWidth=o),onInput:e[1]||(e[1]=(...o)=>n.updateDoorSafe&&n.updateDoorSafe(...o))},null,544),[[ac,n.doorWidth,void 0,{number:!0}]]),fn("label",null,"Высота: "+Ms(n.doorHeight.toFixed(2))+" м",1),Nl(fn("input",{type:"range",min:"1.5",max:"3.0",step:"0.01","onUpdate:modelValue":e[2]||(e[2]=o=>n.doorHeight=o),onInput:e[3]||(e[3]=(...o)=>n.updateDoorSafe&&n.updateDoorSafe(...o))},null,544),[[ac,n.doorHeight,void 0,{number:!0}]]),fn("button",{onClick:e[4]||(e[4]=(...o)=>n.toggleDoor&&n.toggleDoor(...o))},Ms(n.isOpen?"Закрыть":"Открыть"),1)])])}const jx=$f(Xx,[["render",Kx],["__scopeId","data-v-628cf2b5"]]),Zx=zu({__name:"App",setup(n){return(e,t)=>(uf(),Bd(jx))}}),Jx=$f(Zx,[["__scopeId","data-v-47cea995"]]);Ep(Jx).mount("#app");export{iM as C,Qx as M,mi as P,kr as Q,bm as R,nM as S,eM as T,B as V,Ze as a,tM as b};
